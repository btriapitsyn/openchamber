...
export const CommandAutocomplete = React.forwardRef<CommandAutocompleteHandle, CommandAutocompleteProps>(({
  ...
  return (
    <div 
      className="absolute z-[100] min-w-[250px] max-w-[450px] max-h-64 bg-popover border border-border rounded-md shadow-xl bottom-full mb-2 left-0 w-max flex flex-col"
    >
