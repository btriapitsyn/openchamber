        ...
        <>
          {filePath && (
            <div className="mb-2">
              ...
              <code className="text-xs px-2 py-1 bg-muted/30 rounded block break-all">
                {filePath}
              </code>
            </div>
          )}
          ...
          {changes ? (
            ...
            <>
              ...
              {newContent && (
                <div>
                  <div className="text-xs text-muted-foreground mb-1">Replace with:</div>
          ...
          {url && (
            <div className="mb-2">
              ...
              <div className="flex items-center gap-2">
                <span className="text-xs font-semibold px-1.5 py-0.5 bg-primary/20 text-primary rounded">
                  {method}
                </span>
                <code className="text-xs px-2 py-1 bg-muted/30 rounded flex-1 break-all">
                  {url}
                </code>
              </div>
            </div>
      ...
      <>
        ...
        {genericContent && (
          <div className="mb-2">
            ...
            <div className="max-h-32 overflow-y-auto">
              <pre className="text-xs font-mono px-2 py-1 bg-muted/30 rounded whitespace-pre-wrap break-all">
          ...
          <div className="px-2 py-1.5 border-b border-border/20 bg-muted/5">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-xs text-muted-foreground font-medium">{displayToolName}</span>
              </div>
            </div>
          </div>
          ...
          <div className="px-2 py-2">
            ...
            {(() => {
              ...
              if (titleMatchesContent && primaryContent && !shouldHighlight) {
                return (
                  <div className="mb-3">
                    <code className="text-sm px-2 py-1 bg-muted/30 rounded block break-all">
                      {primaryContent}
                    </code>
                  </div>
                );
