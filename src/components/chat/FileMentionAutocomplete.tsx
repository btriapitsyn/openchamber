...
export const FileMentionAutocomplete = React.forwardRef<FileMentionHandle, FileMentionAutocompleteProps>(({
  ...
  return (
    <div 
      className="absolute z-[100] min-w-[200px] max-w-[400px] max-h-64 bg-popover border border-border rounded-md shadow-xl bottom-full mb-2 left-0 w-max flex flex-col"
    >
