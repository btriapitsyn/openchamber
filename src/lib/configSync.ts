...
/**
 * Emit a configuration change event for the provided scopes.
 * Accepts a single scope or an array of scopes.
 */
...
/**
 * Utility helper to test if an event targets a scope.
 */
