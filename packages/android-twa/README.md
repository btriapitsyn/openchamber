...
Set before building. No `.env` file required.

```bash
export TWA_HOST=your-domain.com
export TWA_DEFAULT_URL=https://your-domain.com
# CI also needs: TWA_SHA256_FINGERPRINT, TWA_PACKAGE_NAME
```
...
Set environment variables for your OpenChamber URL.
...
├── configurable-wrapper/ # Pre-built Gradle project
└── README.md          # This file
```
