...
| `item` | der angehängte Eintrag, den der Nutzer angeklickt hat, um diese Oberfläche zu öffnen (dieselben Felder, die du an `attach` übergeben hast, einschließlich `data`), oder `null` |
