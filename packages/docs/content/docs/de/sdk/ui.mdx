...
Die Elemente lesen ihre Farben aus CSS-Variablen, die `applyHostReady` auf die Seite schreibt. Ruf es in `host.onReady` vor dem ersten Mount auf, dann folgen die Farben dem Theme der App, wenn der Nutzer es wechselt.
