...
Drei weitere kommen automatisch dazu: `network`, wenn du eine `integration` deklarierst, `service`, wenn du einen `service` deklarierst, und `filesystem`, wenn du `filesystem`-Muster deklarierst.
