...
| `item` | l'élément attaché sur lequel l'utilisateur a cliqué pour ouvrir cette surface (les mêmes champs que vous avez passés à `attach`, y compris `data`), ou `null` |
