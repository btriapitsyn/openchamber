...
Trzy kolejne są dodawane automatycznie: `network`, gdy deklarujesz `integration`, `service`, gdy deklarujesz `service`, oraz `filesystem`, gdy deklarujesz wzorce `filesystem`.
