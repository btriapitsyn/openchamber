...
Os controles leem suas cores de variáveis CSS que `applyHostReady` escreve na página. Chame-o dentro de `host.onReady` antes da primeira montagem, e as cores acompanham o tema do app quando o usuário troca.
