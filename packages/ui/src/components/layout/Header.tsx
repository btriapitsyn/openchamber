...
import { RiChat4Line, RiCodeLine, RiCommandLine, RiFile2Line, RiGitBranchLine, RiLayoutLeftLine, RiPlayListAddLine, RiQuestionLine, RiSettings3Line, RiTerminalBoxLine, type RemixiconComponentType } from '@remixicon/react';
...
export const Header: React.FC = () => {
  ...
  const tabs: TabConfig[] = React.useMemo(() => [
    ...
    { id: 'files', label: 'Files', icon: RiFile2Line },
