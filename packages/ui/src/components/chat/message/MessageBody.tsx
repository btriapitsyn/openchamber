...
const MessageBody: React.FC<MessageBodyProps> = ({
    ...
    // Do not render assistant content until we have at least one step-finish (any reason) to avoid mid-stream justification flicker
    const hasAnyStepFinish = React.useMemo(() => {
                        ...
                        element = (
                            <FadeInOnReveal key={`assistant-text-${index}`}>
                                <AssistantTextPart
                                    ...
                                    renderAsReasoning={renderTextAsJustification && renderAsReasoningBlock}
                                />
                            </FadeInOnReveal>
                        );
