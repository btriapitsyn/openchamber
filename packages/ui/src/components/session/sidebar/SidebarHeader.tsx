              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <button
                    ...
                    aria-label={m.sidebarHeaderAddProject()}
                  >
                    <RiFolderAddLine className={headerActionIconClass} />
                  </button>
                </TooltipTrigger>
                <TooltipContent side="bottom" sideOffset={4}><p>{m.sidebarHeaderAddProject()}</p></TooltipContent>
              </Tooltip>
              <Tooltip>
                <TooltipTrigger asChild>
                  <button
                    ...
                    className={headerActionButtonClass}
                    aria-label={m.sidebarHeaderNewSession()}
                  >
                    <RiChatNewLine className={headerActionIconClass} />
                  </button>
                </TooltipTrigger>
                <TooltipContent side="bottom" sideOffset={4}><p>{m.sidebarHeaderNewSession()}</p></TooltipContent>
              </Tooltip>
            </div>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <button
                    ...
                    className={headerActionButtonClass}
                    aria-label={m.sidebarHeaderNewMultiRun()}
                    disabled={!canOpenMultiRun}
                  >
                    <ArrowsMerge className={headerActionIconClass} />
                  </button>
                </TooltipTrigger>
                <TooltipContent side="bottom" sideOffset={4}><p>{m.sidebarHeaderNewMultiRun()}</p></TooltipContent>
              </Tooltip>
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <button
                      ...
                      className={headerActionButtonClass}
                      aria-label={m.sidebarHeaderProjectNotes()}
                      disabled={!activeProjectRefForHeader}
                    >
                      <RiStickyNoteLine className={headerActionIconClass} />
                    </button>
                  </TooltipTrigger>
                  <TooltipContent side="bottom" sideOffset={4}><p>{m.sidebarHeaderProjectNotes()}</p></TooltipContent>
                </Tooltip>
              ) : (
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <button
                    ...
                    className={headerActionButtonClass}
                    aria-label={m.sidebarHeaderSearchSessions()}
                    aria-expanded={isSessionSearchOpen}
                  >
                    <RiSearchLine className={headerActionIconClass} />
                  </button>
                </TooltipTrigger>
                <TooltipContent side="bottom" sideOffset={4}><p>{m.sidebarHeaderSearchSessions()}</p></TooltipContent>
              </Tooltip>
              ...
              <DropdownMenu>
                <Tooltip>
                  <TooltipTrigger asChild>
                    ...
                    <TooltipContent side="bottom" sideOffset={4}><p>{m.sidebarHeaderDisplayMode()}</p></TooltipContent>
                </Tooltip>
                <DropdownMenuContent align="end" className="min-w-[160px]">
                  ...
                  >
                    <span>{m.sidebarHeaderDefault()}</span>
          ...
          {isSessionSearchOpen ? (
            <div className="pb-1">
              <div className="mb-1 flex items-center justify-between px-0.5 typography-micro text-muted-foreground/80">
                {hasSessionSearchQuery ? (
                  <span>{searchMatchCount} {searchMatchCount === 1 ? m.sidebarHeaderMatch() : m.sidebarHeaderMatches()}</span>
                ) : <span />}
                <span>{m.sidebarHeaderEscToClear()}</span>
              </div>
              <div className="relative">
                ...
                <input
                  ...
                  placeholder={m.sidebarHeaderSearchPlaceholder()}
                ...
                {sessionSearchQuery.length > 0 ? (
                  <button
                    ...
                    aria-label={m.sidebarHeaderClearSearch()}
                  >
