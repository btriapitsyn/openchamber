import { replaceRepositoryWorktrees, type ProjectRef } from '@/lib/worktrees/worktreeManager';
...
export const refreshProjectWorktreeTopology = async (
  ...
  if (!deps.worktreeMapsEqual(partitionedWorktreesByProject, deps.getPublishedWorktreesByProject())) {
