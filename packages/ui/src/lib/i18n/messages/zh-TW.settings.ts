...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.notifications.page.sounds.title': '通知音效',
  'settings.notifications.page.sounds.enableLabel': '為代理事件播放音效',
  'settings.notifications.page.sounds.enableAria': '為代理事件播放音效',
  'settings.notifications.page.sounds.hint': '為完成、錯誤和問題播放音訊提示。使用上方的焦點和事件設定。',
  'settings.notifications.page.sounds.volumeLabel': '音量',
  'settings.notifications.page.sounds.previewAction': '預覽音效',
  'settings.notifications.page.sounds.previewAria': '預覽通知音效',
