...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.voice.page.field.funasrProtocol': "FunASR 協定",
  'settings.voice.page.field.funasrProtocolHint': "選擇與執行中的伺服器一致的協定：Python 需要 is_end 完成確認；C++ 使用雙遍或離線回應。此設定不會變更伺服器。",
  'settings.voice.page.protocol.python': "Python（完成確認）",
  'settings.voice.page.protocol.cpp2pass': "C++ 雙遍",
  'settings.voice.page.protocol.cppOffline': "C++ 離線",
