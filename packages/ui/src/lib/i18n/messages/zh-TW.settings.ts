...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.providers.freeinference.description': '連接您的 FreeInference API 金鑰以探索並使用可用模型。',
  'settings.providers.freeinference.attribution': '由 Harvard SEAS 的 Harvard MadSys 團隊提供。',
  'settings.providers.freeinference.apiKeyLabel': 'FreeInference API 金鑰',
  'settings.providers.freeinference.apiKeyPlaceholder': '輸入您的 FreeInference API 金鑰',
  'settings.providers.freeinference.connect': '連接 FreeInference',
  'settings.providers.freeinference.connecting': '連線中...',
  'settings.providers.freeinference.syncModels': '重新整理模型',
  'settings.providers.freeinference.syncing': '重新整理中...',
  'settings.providers.freeinference.modelsRefreshed': 'FreeInference 模型已重新整理（{count} 個可用）',
  'settings.providers.freeinference.refreshFailed': '重新整理 FreeInference 模型失敗',
  'settings.providers.freeinference.infoHint': '模型會針對您已通過驗證的金鑰從 FreeInference API 動態擷取。',
