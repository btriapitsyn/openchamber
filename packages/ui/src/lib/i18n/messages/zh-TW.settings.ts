...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.openchamber.tools.field.serverBrowser': '伺服器瀏覽器',
  'settings.openchamber.tools.field.serverBrowserAria': '啟用伺服器瀏覽器',
  'settings.openchamber.tools.field.serverBrowserInfo': '在此伺服器上執行 Chrome 瀏覽器，讓代理在沒有任何已連線視窗可以回應時也能瀏覽頁面，並讓你從任何裝置檢視和操作相同的頁面。預設關閉，立即生效；關閉時會停止 Chrome 並關閉其工作階段與檢視者。',
  'settings.openchamber.tools.browserDebugPort.label': '瀏覽器 CDP 連接埠',
  'settings.openchamber.tools.browserDebugPort.info': '選擇本機 MCP 連線使用的連接埠。儲存的設定會在下次啟動 Chrome 時生效，目前的分頁會保持開啟。',
  'settings.openchamber.tools.browserDebugPort.automatic': '自動',
  'settings.openchamber.tools.browserDebugPort.fixed': '固定連接埠',
  'settings.openchamber.tools.browserDebugPort.input': '固定 CDP 連接埠',
  'settings.openchamber.tools.browserDebugPort.invalid': '請輸入 1 到 65535 之間的整數。',
  'settings.openchamber.tools.browserDebugPort.save': '儲存連接埠',
  'settings.openchamber.tools.browserDebugPort.configuredAutomatic': '已設定的連接埠：自動',
  'settings.openchamber.tools.browserDebugPort.configuredFixed': '已設定的連接埠：{port}',
  'settings.openchamber.tools.browserDebugPort.loading': '正在檢查瀏覽器狀態…',
  'settings.openchamber.tools.browserDebugPort.unavailable': '無法取得瀏覽器狀態。',
  'settings.openchamber.tools.browserDebugPort.stopped': 'Chrome 未執行。',
  'settings.openchamber.tools.browserDebugPort.active': '使用中的連接埠：{port}',
  'settings.openchamber.tools.browserDebugPort.pending': '儲存的連接埠會在下次啟動 Chrome 時生效。',
  'settings.openchamber.tools.browserDebugPort.refresh': '重新整理狀態',
  'settings.openchamber.tools.browserDebugPort.copy': '複製瀏覽器 URL',
  'settings.openchamber.tools.browserDebugPort.copied': '已複製瀏覽器 URL',
  'settings.openchamber.tools.browserDebugPort.copyFailed': '無法複製瀏覽器 URL。',
  'settings.openchamber.tools.browserDebugPort.connectionInfo': '此回送位址屬於伺服器所在的電腦。請在該電腦上使用 --browserUrl 執行 MCP，或使用自行設定的 SSH 通道。直接 MCP 連線不使用「接管控制權」。',
