...
export const settingsDict = {
  ...
  'settings.providers.page.ollamaCloud.help': '請從 ollama.com 瀏覽器開發者工具的要求標頭中複製完整的 Cookie 標頭，然後貼到這裡。僅會儲存並傳送工作階段 Cookie：wos-session=...（舊帳戶可能使用 __Secure-session=...）。標頭中的其他 Cookie 不會被轉送。這不是本機 Ollama API 金鑰或端點。OpenChamber 絕不會掃描瀏覽器 Cookie 儲存空間。',
