...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.gitIdentities.editor.field.account': '原始碼管理帳戶',
  'settings.gitIdentities.editor.field.accountNone': '不使用帳戶',
  'settings.gitIdentities.editor.auth.label': '驗證方式',
  'settings.gitIdentities.editor.auth.account': '帳戶',
  'settings.gitIdentities.editor.auth.ssh': 'SSH',
  'settings.gitIdentities.editor.auth.system': '系統',
  'settings.gitIdentities.editor.auth.anonymous': '匿名',
  'settings.gitIdentities.editor.auth.accountHint': '使用已連線帳戶自身的憑證進行 push 與 pull。',
  'settings.gitIdentities.editor.auth.systemHint': '使用已連線主機上既有的 Git 憑證。OpenChamber 無法確認它們屬於哪個帳戶。',
  'settings.gitIdentities.editor.auth.anonymousHint': '無憑證的公開 HTTPS — 唯讀。',
  ...
  'settings.openchamber.git.agentAuthority': '在代理終端中回應 Git',
  'settings.openchamber.git.agentAuthorityAria': '在代理終端中回應 Git',
  'settings.openchamber.git.agentAuthorityInfo': '對於在此設定的儲存庫，OpenChamber 會把繫結的帳戶提供給代理自己執行的 Git，並要求它使用 OpenChamber 工具而不是直接傳輸。使用系統 Git 的儲存庫與未設定傳輸的儲存庫仍使用本機自己的設定。下次重新啟動 OpenCode 後生效，且從不影響你自己的終端。',
  ...
  'settings.sourceControl.agentAuthority.title': '代理終端',
  'settings.sourceControl.agentAuthority.label': '在此儲存庫中回應 Git',
  'settings.sourceControl.agentAuthority.info': '關閉後，代理在此執行的 Git 會使用本機自己的設定而不是繫結的帳戶，終端中的直接傳輸也不會被拒絕。下次重新啟動 OpenCode 後生效。',
  'settings.sourceControl.agentAuthority.machineOff': '本機已在「設定 → Git」中關閉在代理終端中回應 Git。',
