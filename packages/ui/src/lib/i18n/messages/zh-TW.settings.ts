...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.gitIdentities.editor.auth.token': '權杖',
  'settings.gitIdentities.editor.auth.anonymous': '匿名',
  'settings.gitIdentities.editor.auth.ssh': 'SSH',
  'settings.gitIdentities.editor.auth.oauthHint': '使用帳戶的 OAuth 登入進行 push 與 pull。',
  'settings.gitIdentities.editor.auth.tokenHint': '使用帳戶的個人存取權杖進行 push 與 pull。',
