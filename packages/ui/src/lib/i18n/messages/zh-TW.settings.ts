...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.openchamber.visual.field.activityColorCoding': '工具與活動顏色標識',
  'settings.openchamber.visual.field.activityColorCodingAria': '為工具與活動行使用顏色標識',
  'settings.openchamber.visual.field.activityColorCodingHint': '為每種工具與活動行分配主題強調色——檔案編輯、Shell 命令、搜尋、思考等。關閉後使用單一中性色調。',
