...
export const dict = {
  ...
  'contextRail.surface.server-browser.description': 'Chrome running on the server',
  ...
  'contextPanel.browser.newServerTab': 'New server browser tab',
  'contextPanel.browser.remote.tabLabel': 'Server browser',
  'contextPanel.browser.remote.sessionsMenu': 'Browser sessions',
  'contextPanel.browser.remote.savedSessions': 'Saved sessions',
  'contextPanel.browser.remote.availableSessions': 'Running sessions',
  'contextPanel.browser.remote.openDevTools': 'Open Chrome DevTools',
  'contextPanel.browser.remote.contextMenuUnavailable': 'Browser actions are unavailable for this click. Use the toolbar or clipboard buttons.',
  'contextPanel.browser.remote.devTools': 'Chrome DevTools',
  'contextPanel.browser.remote.simpleInspector': 'Console and network',
  'contextPanel.browser.remote.inspectMode': 'Inspection mode',
  'contextPanel.browser.remote.maximizeInspector': 'Maximize inspector',
  'contextPanel.browser.remote.restoreInspector': 'Restore page and inspector',
  'contextPanel.browser.remote.resizeInspector': 'Resize inspector',
  'contextPanel.browser.remote.devtoolsLoading': 'Connecting Chrome DevTools…',
  'contextPanel.browser.remote.devtoolsLoadFailed': 'Chrome DevTools could not be loaded.',
  'contextPanel.browser.remote.devtoolsRetry': 'Reconnect DevTools',
  'contextPanel.browser.remote.devtoolsControlLost': 'Another viewer took control. Reconnect to continue inspecting.',
  'contextPanel.browser.remote.devtoolsConnectionClosed': 'The DevTools connection closed.',
  'contextPanel.browser.remote.devtoolsMessageTooLarge': 'A DevTools message exceeded the size limit.',
  'contextPanel.browser.remote.devtoolsBackpressure': 'DevTools could not keep up with the connection. Reconnect to continue.',
  'contextPanel.browser.remote.devtoolsInvalidRequest': 'The DevTools connection received an invalid message.',
  'contextPanel.browser.remote.devtoolsProtocolRejected': 'This DevTools action is not available for this page.',
  'contextPanel.browser.remote.devtoolsExclusive': 'Performance recording requires this to be the only running browser session.',
  'contextPanel.browser.remote.devtoolsStartFailed': 'Could not open DevTools for this page.',
  'contextPanel.browser.remote.connecting': 'Connecting to the server browser…',
  'contextPanel.browser.remote.reconnecting': 'Connection lost. Reconnecting…',
  'contextPanel.browser.remote.chooseTitle': 'Server browser sessions',
  'contextPanel.browser.remote.chooseHint': 'Attach to a running session or start a new one.',
  'contextPanel.browser.remote.newSession': 'New session',
  'contextPanel.browser.remote.noSessions': 'No server sessions are running for this project.',
  'contextPanel.browser.remote.sessionEphemeral': 'Agent session',
  'contextPanel.browser.remote.sessionProject': 'Project session',
  'contextPanel.browser.remote.errorTitle': 'The server browser is unavailable',
  'contextPanel.browser.remote.endedTitle': 'This server browser session has ended',
  'contextPanel.browser.remote.retry': 'Try again',
  'contextPanel.browser.remote.canvasAria': 'Remote page view',
  'contextPanel.browser.remote.keyboard': 'Type in page',
  'contextPanel.browser.remote.textInputAria': 'Text input for the remote page',
  'contextPanel.browser.remote.clipboard.copy': 'Copy',
  'contextPanel.browser.remote.clipboard.paste': 'Paste',
  'contextPanel.browser.remote.clipboard.copied': 'Copied to your clipboard',
  'contextPanel.browser.remote.clipboard.pasted': 'Pasted into the page',
  'contextPanel.browser.remote.clipboard.noSelection': 'Select text on the page to copy.',
  'contextPanel.browser.remote.clipboard.copyFailed': 'Could not copy the selection. Try again.',
  'contextPanel.browser.remote.clipboard.pasteFailed': 'Could not paste into the page. Try again.',
  'contextPanel.browser.remote.clipboard.tooLarge': 'This text is too large to transfer.',
  'contextPanel.browser.remote.clipboard.copyFallbackTitle': 'Copy selected text',
  'contextPanel.browser.remote.clipboard.copyFallbackDescription': 'Clipboard access is unavailable. Select and copy the text below.',
  'contextPanel.browser.remote.clipboard.copyTextAria': 'Selected page text',
  'contextPanel.browser.remote.clipboard.pasteFallbackTitle': 'Paste into the page',
  'contextPanel.browser.remote.clipboard.pasteFallbackDescription': 'Paste plain text below, then send it to the page.',
  'contextPanel.browser.remote.clipboard.pasteTextAria': 'Text to paste into the page',
  'contextPanel.browser.remote.clipboard.emptyClipboard': 'Your clipboard has no plain text.',
  'contextPanel.browser.remote.clipboard.cancel': 'Cancel',
  'contextPanel.browser.remote.viewport.auto': 'Auto',
  'contextPanel.browser.remote.viewport.preset': 'Viewport preset',
  'contextPanel.browser.remote.viewport.custom': 'Custom',
  'contextPanel.browser.remote.viewport.width': 'Width',
  'contextPanel.browser.remote.viewport.height': 'Height',
  'contextPanel.browser.remote.viewport.rotate': 'Rotate',
  'contextPanel.browser.remote.viewport.mobile': 'Emulate mobile device',
  'contextPanel.browser.remote.viewport.scale': 'Display scale',
  'contextPanel.browser.remote.viewport.pending': 'Applying viewport…',
  'contextPanel.browser.remote.viewport.error': 'Viewport resize failed: {code}',
  'contextPanel.browser.remote.viewport.agentControlled': 'Agent controls this viewport',
  'contextPanel.browser.remote.viewport.external': 'External DevTools controls this viewport',
  'contextPanel.browser.remote.viewport.dimensionsConfirmed': 'Confirmed: {width} × {height}',
  'contextPanel.browser.remote.inspector.title': 'Page inspector',
  'contextPanel.browser.remote.inspector.open': 'Open page inspector',
  'contextPanel.browser.remote.inspector.close': 'Close inspector',
  'contextPanel.browser.remote.inspector.console': 'Console',
  'contextPanel.browser.remote.inspector.network': 'Network',
  'contextPanel.browser.remote.inspector.clear': 'Clear',
  'contextPanel.browser.remote.inspector.filterPlaceholder': 'Filter messages or requests',
  'contextPanel.browser.remote.inspector.filterAria': 'Filter inspector entries',
  'contextPanel.browser.remote.inspector.capturing': 'Capturing this tab',
  'contextPanel.browser.remote.inspector.starting': 'Starting capture',
  'contextPanel.browser.remote.inspector.captureHint': 'Capture starts when you open the inspector. Closing it clears captured data.',
  'contextPanel.browser.remote.inspector.dropped': 'Entries omitted: {count}',
  'contextPanel.browser.remote.inspector.emptyConsole': 'Console messages will appear here.',
  'contextPanel.browser.remote.inspector.filteredEmpty': 'No matching entries.',
  'contextPanel.browser.remote.inspector.expressionAria': 'JavaScript to run in the page',
  'contextPanel.browser.remote.inspector.expressionPlaceholder': 'Run JavaScript in the page',
  'contextPanel.browser.remote.inspector.run': 'Run',
  'contextPanel.browser.remote.inspector.running': 'Running',
  'contextPanel.browser.remote.inspector.previousCommand': 'Previous command',
  'contextPanel.browser.remote.inspector.nextCommand': 'Next command',
  'contextPanel.browser.remote.inspector.shortcutHint': 'Ctrl/Cmd+Enter to run. Enter adds a new line.',
  'contextPanel.browser.remote.inspector.truncated': 'Truncated',
  'contextPanel.browser.remote.inspector.errorUnavailable': 'The page inspector is unavailable. Reopen it to try again.',
  'contextPanel.browser.remote.inspector.errorInvalid': 'Enter JavaScript with at most 16,000 characters.',
  'contextPanel.browser.remote.inspector.errorCaptureGone': 'Capture ended. Reopen the inspector to start again.',
  'contextPanel.browser.remote.inspector.errorEvaluation': 'Could not run the JavaScript. Try again.',
  'contextPanel.browser.remote.inspector.errorTimeout': 'JavaScript timed out. The page may still be running it.',
  'contextPanel.browser.remote.inspector.errorRequestGone': 'This request is no longer available.',
  'contextPanel.browser.remote.inspector.errorRequest': 'Could not load this request. Try again.',
  'contextPanel.browser.remote.inspector.errorCapture': 'Could not start capture. Reopen the inspector to try again.',
  'contextPanel.browser.remote.inspector.resultAria': 'JavaScript result',
  'contextPanel.browser.remote.inspector.commandAria': 'Executed JavaScript',
  'contextPanel.browser.remote.inspector.level.debug': 'Debug',
  'contextPanel.browser.remote.inspector.level.info': 'Info',
  'contextPanel.browser.remote.inspector.level.log': 'Log',
  'contextPanel.browser.remote.inspector.level.warning': 'Warning',
  'contextPanel.browser.remote.inspector.level.error': 'Error',
  'contextPanel.browser.remote.inspector.network.empty': 'No requests captured yet.',
  'contextPanel.browser.remote.inspector.network.noMatches': 'No requests match this filter.',
  'contextPanel.browser.remote.inspector.network.selectRequest': 'Select a request to inspect it.',
  'contextPanel.browser.remote.inspector.network.details': 'Request details',
  'contextPanel.browser.remote.inspector.network.closeDetails': 'Close request details',
  'contextPanel.browser.remote.inspector.network.loading': 'Loading request details',
  'contextPanel.browser.remote.inspector.network.loadBodies': 'Load bodies',
  'contextPanel.browser.remote.inspector.network.requestHeaders': 'Request headers',
  'contextPanel.browser.remote.inspector.network.responseHeaders': 'Response headers',
  'contextPanel.browser.remote.inspector.network.requestBody': 'Request body',
  'contextPanel.browser.remote.inspector.network.responseBody': 'Response body',
  'contextPanel.browser.remote.inspector.network.noHeaders': 'No headers available.',
  'contextPanel.browser.remote.inspector.network.noBody': 'No body available.',
  'contextPanel.browser.remote.inspector.network.bodiesNotRequested': 'Bodies are loaded only when you request them.',
  'contextPanel.browser.remote.inspector.network.bodiesUnavailable': 'Bodies are no longer available for this request.',
  'contextPanel.browser.remote.inspector.network.bodiesUnsupported': 'Body preview is not supported for this response.',
  'contextPanel.browser.remote.inspector.network.truncated': 'Preview truncated.',
  'contextPanel.browser.remote.inspector.network.method': 'Method',
  'contextPanel.browser.remote.inspector.network.url': 'URL',
  'contextPanel.browser.remote.inspector.network.status': 'Status',
  'contextPanel.browser.remote.inspector.network.duration': 'Duration',
  'contextPanel.browser.remote.inspector.network.size': 'Transferred',
  'contextPanel.browser.remote.inspector.network.state': 'State',
  'contextPanel.browser.remote.inspector.network.cached': 'From cache',
  'contextPanel.browser.remote.inspector.network.failure': 'Failure',
  'contextPanel.browser.remote.inspector.network.resourceType': 'Type',
  'contextPanel.browser.remote.inspector.network.mimeType': 'Content type',
  'contextPanel.browser.remote.inspector.network.pending': 'Pending',
  'contextPanel.browser.remote.inspector.network.complete': 'Complete',
  'contextPanel.browser.remote.inspector.network.failed': 'Failed',
  'contextPanel.browser.remote.inspector.network.unknown': 'Unavailable',
  'contextPanel.browser.remote.inspector.network.yes': 'Yes',
  'contextPanel.browser.remote.inspector.network.no': 'No',
  'contextPanel.browser.remote.inspector.network.failedDetails': 'Could not load request details. Try again.',
  'contextPanel.browser.remote.inspector.network.requestGone': 'This request is no longer available.',
  'contextPanel.browser.remote.inspector.network.captureGone': 'This capture has ended.',
  ...
  'contextPanel.browser.agentControlling': 'Agent controlling',
