...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.gitIdentities.editor.field.account": "Cuenta de control de código",
  "settings.gitIdentities.editor.field.accountNone": "Sin cuenta",
  'settings.gitIdentities.editor.auth.label': 'Autenticación',
  'settings.gitIdentities.editor.auth.oauth': 'OAuth',
  'settings.gitIdentities.editor.auth.token': 'Token',
  'settings.gitIdentities.editor.auth.anonymous': 'Anónimo',
  'settings.gitIdentities.editor.auth.ssh': 'SSH',
  'settings.gitIdentities.editor.auth.oauthHint': 'Push y pull con el inicio de sesión OAuth de la cuenta.',
  'settings.gitIdentities.editor.auth.tokenHint': 'Push y pull con el token de acceso personal de la cuenta.',
  ...
  'settings.openchamber.git.agentAuthority': 'Aplicar identidades en las shells del agente',
  'settings.openchamber.git.agentAuthorityAria': 'Aplicar identidades en las shells del agente',
  'settings.openchamber.git.agentAuthorityInfo': 'El Git que ejecuta el propio agente recibe la identidad del repositorio en lugar de la configuración de este equipo, y se le pide al agente usar la herramienta de OpenChamber en vez de una transferencia directa. Los repositorios con Git del sistema conservan la configuración de este equipo. Se aplica en el próximo reinicio de OpenCode y nunca a tu propia terminal.',
  ...
  'settings.gitlab.status.tokenRejected': 'GitLab no aceptó ese token. Comprueba que pertenece a esta instancia y que tiene acceso a la API.',
  ...
  'settings.sourceControl.accounts.inUse': 'En uso',
  ...
  'settings.sourceControl.agentAuthority.title': 'Shell del agente',
  'settings.sourceControl.agentAuthority.label': 'Aplicar la identidad de este repositorio en la shell del agente',
  'settings.sourceControl.agentAuthority.info': 'Desactivado significa que el Git que el agente ejecuta aquí conserva la configuración de este equipo y las transferencias directas en la shell no se rechazan. Se aplica en el próximo reinicio de OpenCode.',
  'settings.sourceControl.agentAuthority.machineOff': 'Las identidades no se aplican en las shells del agente en este equipo. Actívalo en Configuración → Git.',
  ...
  'settings.page.integrations.description': 'Conecta GitHub, GitLab y Linear para que OpenChamber pueda trabajar con tus issues, pull requests y merge requests.',
} as const;
