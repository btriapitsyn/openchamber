...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.openchamber.git.agentAuthority": "Responder a Git en las shells del agente",
  "settings.openchamber.git.agentAuthorityAria": "Responder a Git en las shells del agente",
  "settings.openchamber.git.agentAuthorityInfo": "En los repositorios configurados aquí, OpenChamber entrega la cuenta vinculada al Git que ejecuta el agente y le pide usar la herramienta de OpenChamber en lugar de una transferencia directa. Los repositorios con Git del sistema y los que no tienen transporte siguen usando la configuración de este equipo. Se aplica al reiniciar OpenCode y nunca en tu propia terminal.",
  ...
  'settings.sourceControl.agentAuthority.label': 'Responder a Git en este repositorio',
  'settings.sourceControl.agentAuthority.info': 'Con esto desactivado, el Git que el agente ejecuta aquí usa la configuración de este equipo en vez de la cuenta vinculada, y no se rechazan las transferencias directas en la shell. Se aplica al reiniciar OpenCode.',
  'settings.sourceControl.agentAuthority.machineOff': 'Responder a Git en las shells del agente está desactivado para este equipo, en Ajustes → Git.',
