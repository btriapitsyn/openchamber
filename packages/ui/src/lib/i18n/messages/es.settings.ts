...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  'settings.gitIdentities.editor.auth.account': 'Cuenta',
  'settings.gitIdentities.editor.auth.ssh': 'SSH',
  'settings.gitIdentities.editor.auth.system': 'Sistema',
  'settings.gitIdentities.editor.auth.anonymous': 'Anónimo',
  'settings.gitIdentities.editor.auth.accountHint': 'Push y pull con la credencial propia de la cuenta conectada.',
  'settings.gitIdentities.editor.auth.systemHint': 'Usa las credenciales de Git que ya tiene el host conectado. OpenChamber no puede verificar a qué cuenta pertenecen.',
  'settings.gitIdentities.editor.auth.anonymousHint': 'HTTPS público sin credenciales — solo lectura.',
