...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  'settings.openchamber.visual.field.activityColorCoding': 'Colorear herramientas y actividad',
  'settings.openchamber.visual.field.activityColorCodingAria': 'Colorear las filas de herramientas y actividad',
  'settings.openchamber.visual.field.activityColorCodingHint': 'Asigna un color de acento del tema a cada tipo de fila de herramienta y actividad: ediciones de archivos, comandos de shell, búsquedas, pensamiento y más. Desactívalo para un único tono neutro.',
