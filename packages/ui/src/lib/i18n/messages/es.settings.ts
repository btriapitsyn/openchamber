...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.providers.freeinference.description": "Conecta tu clave de API de FreeInference para descubrir y usar los modelos disponibles.",
  "settings.providers.freeinference.attribution": "Proporcionado por el Grupo MadSys de Harvard en Harvard SEAS.",
  "settings.providers.freeinference.apiKeyLabel": "Clave de API de FreeInference",
  "settings.providers.freeinference.apiKeyPlaceholder": "Introduce tu clave de API de FreeInference",
  "settings.providers.freeinference.connect": "Conectar FreeInference",
  "settings.providers.freeinference.connecting": "Conectando...",
  "settings.providers.freeinference.syncModels": "Actualizar modelos",
  "settings.providers.freeinference.syncing": "Actualizando...",
  "settings.providers.freeinference.modelsRefreshed": "Modelos de FreeInference actualizados ({count} disponibles)",
  "settings.providers.freeinference.refreshFailed": "Error al actualizar los modelos de FreeInference",
  "settings.providers.freeinference.infoHint": "Los modelos se obtienen dinámicamente de la API de FreeInference para tu clave autenticada.",
