...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.voice.page.field.funasrProtocol": "Protocolo FunASR",
  "settings.voice.page.field.funasrProtocolHint": "Elige el protocolo del servidor en ejecución: Python requiere la confirmación de finalización is_end; C++ usa la respuesta de dos pasadas o sin conexión. Esto no cambia el servidor.",
  "settings.voice.page.protocol.python": "Python (confirmación final)",
  "settings.voice.page.protocol.cpp2pass": "C++ de dos pasadas",
  "settings.voice.page.protocol.cppOffline": "C++ sin conexión",
