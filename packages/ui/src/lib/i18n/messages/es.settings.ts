...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.openchamber.tools.field.serverBrowser": "Navegador del servidor",
  "settings.openchamber.tools.field.serverBrowserAria": "Activar el navegador del servidor",
  "settings.openchamber.tools.field.serverBrowserInfo": "Ejecuta un navegador Chrome en este servidor para que los agentes puedan navegar aunque ninguna ventana conectada pueda atenderlos, y para que puedas ver y controlar las mismas páginas desde cualquier dispositivo. Desactivado por defecto y se aplica de inmediato; al desactivarlo, Chrome se detiene y sus sesiones y visores se cierran.",
  "settings.openchamber.tools.browserDebugPort.label": "Puerto CDP del navegador",
  "settings.openchamber.tools.browserDebugPort.info": "Elige el puerto para las conexiones MCP locales. El cambio guardado se aplica la próxima vez que se inicie Chrome y mantiene abiertas las pestañas actuales.",
  "settings.openchamber.tools.browserDebugPort.automatic": "Automático",
  "settings.openchamber.tools.browserDebugPort.fixed": "Puerto fijo",
  "settings.openchamber.tools.browserDebugPort.input": "Puerto CDP fijo",
  "settings.openchamber.tools.browserDebugPort.invalid": "Introduce un número entero del 1 al 65535.",
  "settings.openchamber.tools.browserDebugPort.save": "Guardar puerto",
  "settings.openchamber.tools.browserDebugPort.configuredAutomatic": "Puerto configurado: automático",
  "settings.openchamber.tools.browserDebugPort.configuredFixed": "Puerto configurado: {port}",
  "settings.openchamber.tools.browserDebugPort.loading": "Comprobando el estado del navegador…",
  "settings.openchamber.tools.browserDebugPort.unavailable": "El estado del navegador no está disponible.",
  "settings.openchamber.tools.browserDebugPort.stopped": "Chrome no está en ejecución.",
  "settings.openchamber.tools.browserDebugPort.active": "Puerto activo: {port}",
  "settings.openchamber.tools.browserDebugPort.pending": "El puerto guardado se aplicará la próxima vez que se inicie Chrome.",
  "settings.openchamber.tools.browserDebugPort.refresh": "Actualizar estado",
  "settings.openchamber.tools.browserDebugPort.copy": "Copiar URL del navegador",
  "settings.openchamber.tools.browserDebugPort.copied": "URL del navegador copiada",
  "settings.openchamber.tools.browserDebugPort.copyFailed": "No se pudo copiar la URL del navegador.",
  "settings.openchamber.tools.browserDebugPort.connectionInfo": "Esta dirección de bucle local pertenece al equipo del servidor. Ejecuta MCP allí con --browserUrl o usa tu propio túnel SSH. Las conexiones MCP directas no usan Tomar el control.",
