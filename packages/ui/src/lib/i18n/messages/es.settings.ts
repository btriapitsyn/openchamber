...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.notifications.page.sounds.title": "Sonidos de notificación",
  "settings.notifications.page.sounds.enableLabel": "Reproducir sonidos para eventos del agente",
  "settings.notifications.page.sounds.enableAria": "Reproducir sonidos para eventos del agente",
  "settings.notifications.page.sounds.hint": "Reproduce señales de audio para finalizaciones, errores y preguntas. Usa la configuración de foco y eventos de arriba.",
  "settings.notifications.page.sounds.volumeLabel": "Volumen",
  "settings.notifications.page.sounds.previewAction": "Vista previa de sonido",
  "settings.notifications.page.sounds.previewAria": "Vista previa del sonido de notificación",
  "settings.notifications.page.sounds.perEventTitle": "Sonido por evento",
  "settings.notifications.page.sounds.focusOnlyLabel": "Reproducir solo sin foco",
  "settings.notifications.page.sounds.focusOnlyAria": "Reproducir sonidos solo cuando la ventana no está enfocada",
  "settings.notifications.page.sounds.focusOnlyHint": "Activado: todos los sonidos solo se reproducen sin foco. Desactivado (predeterminado): todos los sonidos se reproducen independientemente del foco.",
