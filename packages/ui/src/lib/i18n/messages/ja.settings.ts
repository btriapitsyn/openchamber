...
'settings.remoteInstances.clientAuth.actions.addDevice': 'デバイスを追加',
  ...
  'settings.providers.freeinference.description': 'FreeInference API キーを接続して、利用可能なモデルを検出して使用します。',
  'settings.providers.freeinference.attribution': 'Harvard SEAS の Harvard MadSys Group によって提供されています。',
  'settings.providers.freeinference.apiKeyLabel': 'FreeInference API キー',
  'settings.providers.freeinference.apiKeyPlaceholder': 'FreeInference API キーを入力',
  'settings.providers.freeinference.connect': 'FreeInference を接続',
  'settings.providers.freeinference.connecting': '接続中...',
  'settings.providers.freeinference.syncModels': 'モデルを更新',
  'settings.providers.freeinference.syncing': '更新中...',
  'settings.providers.freeinference.modelsRefreshed': 'FreeInference モデルを更新しました ({count} 件利用可能)',
  'settings.providers.freeinference.refreshFailed': 'FreeInference モデルの更新に失敗しました',
  'settings.providers.freeinference.infoHint': 'モデルは、認証されたキーに応じて FreeInference API から動的に取得されます。',
