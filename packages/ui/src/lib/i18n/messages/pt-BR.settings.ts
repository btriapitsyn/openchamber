...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.voice.page.field.funasrProtocolHint": "Escolha o protocolo do servidor em execução: Python exige a confirmação de conclusão is_end; C++ usa a resposta de duas passagens ou offline. Esta opção não altera o servidor.",
  "settings.voice.page.protocol.python": "Python (confirmação final)",
  "settings.voice.page.protocol.cpp2pass": "C++ de duas passagens",
  "settings.voice.page.protocol.cppOffline": "C++ offline",
