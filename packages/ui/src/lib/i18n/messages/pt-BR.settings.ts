...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  'settings.gitIdentities.editor.auth.account': 'Conta',
  ...
  'settings.gitIdentities.editor.auth.accountHint': 'Push e pull com a credencial da própria conta conectada.',
  'settings.gitIdentities.editor.auth.systemHint': 'Usa as credenciais Git que o host conectado já tem. O OpenChamber não consegue verificar a qual conta pertencem.',
  'settings.gitIdentities.editor.auth.anonymousHint': 'HTTPS público sem credenciais — somente leitura.',
  ...
  "settings.openchamber.git.agentAuthority": "Responder ao Git nos shells do agente",
  "settings.openchamber.git.agentAuthorityAria": "Responder ao Git nos shells do agente",
  "settings.openchamber.git.agentAuthorityInfo": "Nos repositórios configurados aqui, o OpenChamber entrega a conta vinculada ao Git que o agente executa e pede que ele use a ferramenta do OpenChamber em vez de uma transferência direta. Repositórios em Git do sistema e sem transporte continuam usando a configuração deste computador. Vale a partir do próximo reinício do OpenCode e nunca no seu próprio terminal.",
  ...
  'settings.sourceControl.agentAuthority.label': 'Responder ao Git neste repositório',
  'settings.sourceControl.agentAuthority.info': 'Com isto desligado, o Git que o agente executa aqui usa a configuração deste computador em vez da conta vinculada, e transferências diretas no shell não são recusadas. Vale a partir do próximo reinício do OpenCode.',
  'settings.sourceControl.agentAuthority.machineOff': 'Responder ao Git nos shells do agente está desligado para este computador, em Configurações → Git.',
