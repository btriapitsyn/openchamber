...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.providers.freeinference.description": "Conecte sua chave de API do FreeInference para descobrir e usar os modelos disponíveis.",
  "settings.providers.freeinference.attribution": "Fornecido pelo Grupo MadSys de Harvard na Harvard SEAS.",
  "settings.providers.freeinference.apiKeyLabel": "Chave de API do FreeInference",
  "settings.providers.freeinference.apiKeyPlaceholder": "Digite sua chave de API do FreeInference",
  "settings.providers.freeinference.connect": "Conectar FreeInference",
  "settings.providers.freeinference.connecting": "Conectando...",
  "settings.providers.freeinference.syncModels": "Atualizar modelos",
  "settings.providers.freeinference.syncing": "Atualizando...",
  "settings.providers.freeinference.modelsRefreshed": "Modelos do FreeInference atualizados ({count} disponíveis)",
  "settings.providers.freeinference.refreshFailed": "Falha ao atualizar os modelos do FreeInference",
  "settings.providers.freeinference.infoHint": "Os modelos são obtidos dinamicamente da API do FreeInference para sua chave autenticada.",
