...
export const settingsDict = {
  ...
  'settings.providers.freeinference.description': 'Connect your FreeInference API key to discover and use available models.',
  'settings.providers.freeinference.attribution': 'Provided by the Harvard MadSys Group at Harvard SEAS.',
  'settings.providers.freeinference.apiKeyLabel': 'FreeInference API Key',
  'settings.providers.freeinference.apiKeyPlaceholder': 'Enter your FreeInference API key',
  'settings.providers.freeinference.connect': 'Connect FreeInference',
  'settings.providers.freeinference.connecting': 'Connecting...',
  'settings.providers.freeinference.syncModels': 'Refresh Models',
  'settings.providers.freeinference.syncing': 'Refreshing...',
  'settings.providers.freeinference.modelsRefreshed': 'FreeInference models refreshed ({count} available)',
  'settings.providers.freeinference.refreshFailed': 'Failed to refresh FreeInference models',
  'settings.providers.freeinference.infoHint': 'Models are dynamically fetched from the FreeInference API for your authenticated key.',
