...
export const settingsDict = {
  ...
  'settings.gitIdentities.editor.auth.account': 'Account',
  ...
  'settings.gitIdentities.editor.auth.accountHint': 'Pushes and pulls with the connected account\'s own credential.',
  'settings.gitIdentities.editor.auth.systemHint': 'Uses the Git credentials the connected host already has. OpenChamber cannot verify which account they belong to.',
  'settings.gitIdentities.editor.auth.anonymousHint': 'Public HTTPS without credentials — read-only.',
  ...
  'settings.openchamber.git.agentAuthority': 'Answer Git in agent shells',
  'settings.openchamber.git.agentAuthorityAria': 'Answer Git in agent shells',
  'settings.openchamber.git.agentAuthorityInfo': "For repositories configured here, OpenChamber supplies the bound account to Git the agent runs itself, and asks it to use the OpenChamber tool instead of a raw transfer. Repositories on System Git and repositories with no transport keep using this computer's own setup. Applies on the next OpenCode restart, and never to your own terminal.",
  ...
  'settings.sourceControl.agentAuthority.label': 'Answer Git for this repository',
  'settings.sourceControl.agentAuthority.info': "When this is off, Git the agent runs here uses this computer's own setup instead of the bound account, and raw transfers in the shell are not refused. Applies on the next OpenCode restart.",
  'settings.sourceControl.agentAuthority.machineOff': 'Answering Git in agent shells is off for this computer, in Settings → Git.',
