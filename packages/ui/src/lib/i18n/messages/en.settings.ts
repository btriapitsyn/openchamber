...
export const settingsDict = {
  ...
  'settings.voice.page.field.funasrProtocol': "FunASR protocol",
  'settings.voice.page.field.funasrProtocolHint': "Match the running server: Python requires the is_end completion acknowledgement; C++ uses its 2-pass or offline response. This does not change the server.",
  'settings.voice.page.protocol.python': "Python (completion ACK)",
  'settings.voice.page.protocol.cpp2pass': "C++ 2-pass",
