...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.voice.page.field.funasrProtocol": "Протокол FunASR",
  "settings.voice.page.field.funasrProtocolHint": "Виберіть протокол запущеного сервера: Python потребує підтвердження завершення is_end; C++ використовує двопрохідну або офлайн-відповідь. Це налаштування не змінює сервер.",
  "settings.voice.page.protocol.python": "Python (підтвердження завершення)",
  "settings.voice.page.protocol.cpp2pass": "C++ двопрохідний",
  "settings.voice.page.protocol.cppOffline": "C++ офлайн",
