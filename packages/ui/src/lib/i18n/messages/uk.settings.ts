...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  'settings.gitIdentities.editor.auth.account': 'Акаунт',
  'settings.gitIdentities.editor.auth.ssh': 'SSH',
  'settings.gitIdentities.editor.auth.system': 'Система',
  'settings.gitIdentities.editor.auth.anonymous': 'Анонімно',
  'settings.gitIdentities.editor.auth.accountHint': 'Push і pull з власними обліковими даними підключеного акаунта.',
  'settings.gitIdentities.editor.auth.systemHint': 'Використовує облікові дані Git, які вже є на підключеному хості. OpenChamber не може перевірити, якому акаунту вони належать.',
  'settings.gitIdentities.editor.auth.anonymousHint': 'Публічний HTTPS без облікових даних — лише читання.',
  ...
  "settings.openchamber.git.agentAuthority": "Відповідати git у шелах агента",
  "settings.openchamber.git.agentAuthorityAria": "Відповідати git у шелах агента",
  "settings.openchamber.git.agentAuthorityInfo": "Для налаштованих тут репозиторіїв OpenChamber передає прив'язаний обліковий запис у git, який агент запускає сам, і просить його користуватися тулом OpenChamber замість прямої передачі. Репозиторії на системному git і ті, де транспорт не налаштований, далі користуються налаштуваннями цього комп'ютера. Діє з наступного перезапуску OpenCode і ніколи не стосується твого власного термінала.",
  ...
  'settings.sourceControl.agentAuthority.label': 'Відповідати git у цьому репозиторії',
  'settings.sourceControl.agentAuthority.info': "Коли вимкнено, git, який агент запускає тут, користується налаштуваннями цього комп'ютера замість прив'язаного облікового запису, а прямі передачі в шелі не відхиляються. Діє з наступного перезапуску OpenCode.",
  'settings.sourceControl.agentAuthority.machineOff': "Відповідати git у шелах агента вимкнено для цього комп'ютера, у Налаштуваннях → Git.",
