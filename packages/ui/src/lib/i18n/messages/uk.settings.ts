...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.providers.freeinference.description": "Підключіть ключ API FreeInference, щоб виявляти та використовувати доступні моделі.",
  "settings.providers.freeinference.attribution": "Надається Harvard MadSys Group у Harvard SEAS.",
  "settings.providers.freeinference.apiKeyLabel": "Ключ API FreeInference",
  "settings.providers.freeinference.apiKeyPlaceholder": "Введіть ключ API FreeInference",
  "settings.providers.freeinference.connect": "Підключити FreeInference",
  "settings.providers.freeinference.connecting": "Підключення...",
  "settings.providers.freeinference.syncModels": "Оновити моделі",
  "settings.providers.freeinference.syncing": "Оновлення...",
  "settings.providers.freeinference.modelsRefreshed": "Моделі FreeInference оновлено ({count} доступно)",
  "settings.providers.freeinference.refreshFailed": "Не вдалося оновити моделі FreeInference",
  "settings.providers.freeinference.infoHint": "Моделі динамічно отримуються з API FreeInference для вашого автентифікованого ключа.",
