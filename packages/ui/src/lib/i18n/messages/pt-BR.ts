...
export const dict: Record<I18nKey, string> = {
  ...
  "contextRail.surface.server-browser.description": "Chrome em execução no servidor",
  ...
  "contextPanel.browser.newServerTab": "Nova aba do navegador do servidor",
  "contextPanel.browser.remote.tabLabel": "Navegador do servidor",
  "contextPanel.browser.remote.sessionsMenu": "Sessões do navegador",
  "contextPanel.browser.remote.savedSessions": "Sessões salvas",
  "contextPanel.browser.remote.availableSessions": "Sessões em execução",
  "contextPanel.browser.remote.openDevTools": "Abrir Chrome DevTools",
  'contextPanel.browser.remote.contextMenuUnavailable': 'As ações do navegador não estão disponíveis para este clique. Use a barra de ferramentas ou os botões da área de transferência.',
  "contextPanel.browser.remote.devTools": "Chrome DevTools",
  "contextPanel.browser.remote.simpleInspector": "Console e rede",
  "contextPanel.browser.remote.inspectMode": "Modo de inspeção",
  "contextPanel.browser.remote.maximizeInspector": "Maximizar o inspetor",
  "contextPanel.browser.remote.restoreInspector": "Restaurar a página e o inspetor",
  "contextPanel.browser.remote.resizeInspector": "Redimensionar o inspetor",
  "contextPanel.browser.remote.devtoolsLoading": "Conectando Chrome DevTools…",
  "contextPanel.browser.remote.devtoolsLoadFailed": "Não foi possível carregar o Chrome DevTools.",
  "contextPanel.browser.remote.devtoolsRetry": "Reconectar DevTools",
  "contextPanel.browser.remote.devtoolsControlLost": "Outro visualizador assumiu o controle. Reconecte para continuar inspecionando.",
  "contextPanel.browser.remote.devtoolsConnectionClosed": "A conexão do DevTools foi fechada.",
  "contextPanel.browser.remote.devtoolsMessageTooLarge": "Uma mensagem do DevTools excedeu o limite de tamanho.",
  "contextPanel.browser.remote.devtoolsBackpressure": "O DevTools não conseguiu acompanhar o ritmo da conexão. Reconecte para continuar.",
  "contextPanel.browser.remote.devtoolsInvalidRequest": "A conexão do DevTools recebeu uma mensagem inválida.",
  "contextPanel.browser.remote.devtoolsProtocolRejected": "Esta ação do DevTools não está disponível para esta página.",
  "contextPanel.browser.remote.devtoolsExclusive": "Para gravar o desempenho, esta deve ser a única sessão do navegador em execução.",
  "contextPanel.browser.remote.devtoolsStartFailed": "Não foi possível abrir o DevTools para esta página.",
  "contextPanel.browser.remote.connecting": "Conectando ao navegador do servidor…",
  "contextPanel.browser.remote.reconnecting": "Conexão perdida. Reconectando…",
  "contextPanel.browser.remote.chooseTitle": "Sessões do navegador do servidor",
  "contextPanel.browser.remote.chooseHint": "Anexe-se a uma sessão em execução ou inicie uma nova.",
  "contextPanel.browser.remote.newSession": "Nova sessão",
  "contextPanel.browser.remote.noSessions": "Nenhuma sessão do servidor em execução para este projeto.",
  "contextPanel.browser.remote.sessionEphemeral": "Sessão do agente",
  "contextPanel.browser.remote.sessionProject": "Sessão do projeto",
  "contextPanel.browser.remote.errorTitle": "O navegador do servidor está indisponível",
  "contextPanel.browser.remote.endedTitle": "Esta sessão do navegador do servidor foi encerrada",
  "contextPanel.browser.remote.retry": "Tentar novamente",
  "contextPanel.browser.remote.canvasAria": "Visualização da página remota",
  "contextPanel.browser.remote.keyboard": "Digitar na página",
  "contextPanel.browser.remote.textInputAria": "Entrada de texto para a página remota",
  "contextPanel.browser.remote.clipboard.copy": "Copiar",
  "contextPanel.browser.remote.clipboard.paste": "Colar",
  "contextPanel.browser.remote.clipboard.copied": "Copiado para sua área de transferência",
  "contextPanel.browser.remote.clipboard.pasted": "Colado na página",
  "contextPanel.browser.remote.clipboard.noSelection": "Selecione texto na página para copiar.",
  "contextPanel.browser.remote.clipboard.copyFailed": "Não foi possível copiar a seleção. Tente novamente.",
  "contextPanel.browser.remote.clipboard.pasteFailed": "Não foi possível colar na página. Tente novamente.",
  "contextPanel.browser.remote.clipboard.tooLarge": "Este texto é grande demais para transferir.",
  "contextPanel.browser.remote.clipboard.copyFallbackTitle": "Copiar texto selecionado",
  "contextPanel.browser.remote.clipboard.copyFallbackDescription": "O acesso à área de transferência está indisponível. Selecione e copie o texto abaixo.",
  "contextPanel.browser.remote.clipboard.copyTextAria": "Texto selecionado da página",
  "contextPanel.browser.remote.clipboard.pasteFallbackTitle": "Colar na página",
  "contextPanel.browser.remote.clipboard.pasteFallbackDescription": "Cole texto sem formatação abaixo e envie para a página.",
  "contextPanel.browser.remote.clipboard.pasteTextAria": "Texto para colar na página",
  "contextPanel.browser.remote.clipboard.emptyClipboard": "Sua área de transferência não contém texto sem formatação.",
  "contextPanel.browser.remote.clipboard.cancel": "Cancelar",
  "contextPanel.browser.remote.viewport.auto": "Automático",
  "contextPanel.browser.remote.viewport.preset": "Tamanho de visualização predefinido",
  "contextPanel.browser.remote.viewport.custom": "Personalizado",
  "contextPanel.browser.remote.viewport.width": "Largura",
  "contextPanel.browser.remote.viewport.height": "Altura",
  "contextPanel.browser.remote.viewport.rotate": "Girar",
  "contextPanel.browser.remote.viewport.mobile": "Emular dispositivo móvel",
  "contextPanel.browser.remote.viewport.scale": "Escala de exibição",
  "contextPanel.browser.remote.viewport.pending": "Aplicando tamanho de visualização…",
  "contextPanel.browser.remote.viewport.error": "Falha ao redimensionar a visualização: {code}",
  "contextPanel.browser.remote.viewport.agentControlled": "O agente controla esta visualização",
  "contextPanel.browser.remote.viewport.external": "O DevTools externo controla esta visualização",
  "contextPanel.browser.remote.viewport.dimensionsConfirmed": "Confirmado: {width} × {height}",
  "contextPanel.browser.remote.inspector.title": "Inspetor de página",
  "contextPanel.browser.remote.inspector.open": "Abrir o inspetor de página",
  "contextPanel.browser.remote.inspector.close": "Fechar o inspetor",
  "contextPanel.browser.remote.inspector.console": "Console",
  "contextPanel.browser.remote.inspector.network": "Rede",
  "contextPanel.browser.remote.inspector.clear": "Limpar",
  "contextPanel.browser.remote.inspector.filterPlaceholder": "Filtrar mensagens ou solicitações",
  "contextPanel.browser.remote.inspector.filterAria": "Filtrar entradas do inspetor",
  "contextPanel.browser.remote.inspector.capturing": "Capturando esta aba",
  "contextPanel.browser.remote.inspector.starting": "Iniciando captura",
  "contextPanel.browser.remote.inspector.captureHint": "A captura começa ao abrir o inspetor. Ao fechá-lo, os dados capturados são apagados.",
  "contextPanel.browser.remote.inspector.dropped": "Entradas omitidas: {count}",
  "contextPanel.browser.remote.inspector.emptyConsole": "As mensagens do console aparecerão aqui.",
  "contextPanel.browser.remote.inspector.filteredEmpty": "Nenhuma entrada correspondente.",
  "contextPanel.browser.remote.inspector.expressionAria": "JavaScript para executar na página",
  "contextPanel.browser.remote.inspector.expressionPlaceholder": "Executar JavaScript na página",
  "contextPanel.browser.remote.inspector.run": "Executar",
  "contextPanel.browser.remote.inspector.running": "Executando",
  "contextPanel.browser.remote.inspector.previousCommand": "Comando anterior",
  "contextPanel.browser.remote.inspector.nextCommand": "Próximo comando",
  "contextPanel.browser.remote.inspector.shortcutHint": "Ctrl/Cmd+Enter para executar. Enter adiciona uma nova linha.",
  "contextPanel.browser.remote.inspector.truncated": "Truncado",
  "contextPanel.browser.remote.inspector.errorUnavailable": "O inspetor de página está indisponível. Abra-o novamente para tentar de novo.",
  "contextPanel.browser.remote.inspector.errorInvalid": "Insira JavaScript com no máximo 16.000 caracteres.",
  "contextPanel.browser.remote.inspector.errorCaptureGone": "A captura terminou. Abra o inspetor novamente para recomeçar.",
  "contextPanel.browser.remote.inspector.errorEvaluation": "Não foi possível executar o JavaScript. Tente novamente.",
  "contextPanel.browser.remote.inspector.errorTimeout": "O JavaScript excedeu o tempo limite. A página pode ainda estar executando o código.",
  "contextPanel.browser.remote.inspector.errorRequestGone": "Esta solicitação não está mais disponível.",
  "contextPanel.browser.remote.inspector.errorRequest": "Não foi possível carregar esta solicitação. Tente novamente.",
  "contextPanel.browser.remote.inspector.errorCapture": "Não foi possível iniciar a captura. Abra o inspetor novamente para tentar de novo.",
  "contextPanel.browser.remote.inspector.resultAria": "Resultado do JavaScript",
  "contextPanel.browser.remote.inspector.commandAria": "JavaScript executado",
  "contextPanel.browser.remote.inspector.level.debug": "Depuração",
  "contextPanel.browser.remote.inspector.level.info": "Informação",
  "contextPanel.browser.remote.inspector.level.log": "Registro",
  "contextPanel.browser.remote.inspector.level.warning": "Aviso",
  "contextPanel.browser.remote.inspector.level.error": "Erro",
  "contextPanel.browser.remote.inspector.network.empty": "Nenhuma solicitação capturada ainda.",
  "contextPanel.browser.remote.inspector.network.noMatches": "Nenhuma solicitação corresponde a este filtro.",
  "contextPanel.browser.remote.inspector.network.selectRequest": "Selecione uma solicitação para inspecioná-la.",
  "contextPanel.browser.remote.inspector.network.details": "Detalhes da solicitação",
  "contextPanel.browser.remote.inspector.network.closeDetails": "Fechar os detalhes da solicitação",
  "contextPanel.browser.remote.inspector.network.loading": "Carregando os detalhes da solicitação",
  "contextPanel.browser.remote.inspector.network.loadBodies": "Carregar corpos",
  "contextPanel.browser.remote.inspector.network.requestHeaders": "Cabeçalhos da solicitação",
  "contextPanel.browser.remote.inspector.network.responseHeaders": "Cabeçalhos da resposta",
  "contextPanel.browser.remote.inspector.network.requestBody": "Corpo da solicitação",
  "contextPanel.browser.remote.inspector.network.responseBody": "Corpo da resposta",
  "contextPanel.browser.remote.inspector.network.noHeaders": "Nenhum cabeçalho disponível.",
  "contextPanel.browser.remote.inspector.network.noBody": "Nenhum corpo disponível.",
  "contextPanel.browser.remote.inspector.network.bodiesNotRequested": "Os corpos só são carregados quando você solicita.",
  "contextPanel.browser.remote.inspector.network.bodiesUnavailable": "Os corpos desta solicitação não estão mais disponíveis.",
  "contextPanel.browser.remote.inspector.network.bodiesUnsupported": "A prévia do corpo não é compatível com esta resposta.",
  "contextPanel.browser.remote.inspector.network.truncated": "Prévia truncada.",
  ...
  "contextPanel.browser.remote.inspector.network.duration": "Duração",
  "contextPanel.browser.remote.inspector.network.size": "Transferido",
  "contextPanel.browser.remote.inspector.network.state": "Estado",
  "contextPanel.browser.remote.inspector.network.cached": "Do cache",
  "contextPanel.browser.remote.inspector.network.failure": "Falha",
  "contextPanel.browser.remote.inspector.network.resourceType": "Tipo",
  "contextPanel.browser.remote.inspector.network.mimeType": "Tipo de conteúdo",
  "contextPanel.browser.remote.inspector.network.pending": "Pendente",
  "contextPanel.browser.remote.inspector.network.complete": "Concluída",
  "contextPanel.browser.remote.inspector.network.failed": "Falhou",
  "contextPanel.browser.remote.inspector.network.unknown": "Indisponível",
  "contextPanel.browser.remote.inspector.network.yes": "Sim",
  "contextPanel.browser.remote.inspector.network.no": "Não",
  "contextPanel.browser.remote.inspector.network.failedDetails": "Não foi possível carregar os detalhes da solicitação. Tente novamente.",
  "contextPanel.browser.remote.inspector.network.requestGone": "Esta solicitação não está mais disponível.",
  "contextPanel.browser.remote.inspector.network.captureGone": "Esta captura terminou.",
  ...
  "contextPanel.browser.agentControlling": "Agente em controle",
