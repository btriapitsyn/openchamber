...
export const settingsDict = {
  ...
  'settings.openchamber.visual.field.activityColorCoding': 'Colorer les outils et l\'activité',
  'settings.openchamber.visual.field.activityColorCodingAria': 'Colorer les lignes d\'outils et d\'activité',
  'settings.openchamber.visual.field.activityColorCodingHint': 'Attribue à chaque type de ligne d\'outil et d\'activité une couleur d\'accent du thème — modifications de fichiers, commandes shell, recherches, réflexion et plus. Désactivez pour un seul ton neutre.',
