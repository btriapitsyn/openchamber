...
export const settingsDict = {
  ...
  'settings.openchamber.tools.field.serverBrowser': 'Navigateur du serveur',
  'settings.openchamber.tools.field.serverBrowserAria': 'Activer le navigateur du serveur',
  'settings.openchamber.tools.field.serverBrowserInfo': 'Exécute un navigateur Chrome sur ce serveur pour que les agents puissent naviguer même lorsqu’aucune fenêtre connectée ne peut répondre, et pour que vous puissiez consulter et piloter les mêmes pages depuis n’importe quel appareil. Désactivé par défaut et appliqué immédiatement ; sa désactivation arrête Chrome et ferme ses sessions et ses observateurs.',
  'settings.openchamber.tools.browserDebugPort.label': 'Port CDP du navigateur',
  'settings.openchamber.tools.browserDebugPort.info': 'Choisissez le port des connexions MCP locales. Le changement enregistré prendra effet au prochain démarrage de Chrome et laisse les onglets actuels ouverts.',
  'settings.openchamber.tools.browserDebugPort.automatic': 'Automatique',
  'settings.openchamber.tools.browserDebugPort.fixed': 'Port fixe',
  'settings.openchamber.tools.browserDebugPort.input': 'Port CDP fixe',
  'settings.openchamber.tools.browserDebugPort.invalid': 'Saisissez un nombre entier entre 1 et 65535.',
  'settings.openchamber.tools.browserDebugPort.save': 'Enregistrer le port',
  'settings.openchamber.tools.browserDebugPort.configuredAutomatic': 'Port configuré : automatique',
  'settings.openchamber.tools.browserDebugPort.configuredFixed': 'Port configuré : {port}',
  'settings.openchamber.tools.browserDebugPort.loading': 'Vérification de l\'état du navigateur…',
  'settings.openchamber.tools.browserDebugPort.unavailable': 'L\'état du navigateur est indisponible.',
  'settings.openchamber.tools.browserDebugPort.stopped': 'Chrome n\'est pas en cours d\'exécution.',
  'settings.openchamber.tools.browserDebugPort.active': 'Port actif : {port}',
  'settings.openchamber.tools.browserDebugPort.pending': 'Le port enregistré prendra effet au prochain démarrage de Chrome.',
  'settings.openchamber.tools.browserDebugPort.refresh': 'Actualiser l\'état',
  'settings.openchamber.tools.browserDebugPort.copy': 'Copier l\'URL du navigateur',
  'settings.openchamber.tools.browserDebugPort.copied': 'URL du navigateur copiée',
  'settings.openchamber.tools.browserDebugPort.copyFailed': 'Impossible de copier l\'URL du navigateur.',
  'settings.openchamber.tools.browserDebugPort.connectionInfo': 'Cette adresse de bouclage appartient à la machine du serveur. Exécutez MCP sur cette machine avec --browserUrl ou utilisez votre propre tunnel SSH. Les connexions MCP directes n\'utilisent pas Prendre le contrôle.',
