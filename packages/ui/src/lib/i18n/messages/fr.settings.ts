...
export const settingsDict = {
  ...
  'settings.gitIdentities.editor.field.account': 'Compte de gestion de code',
  'settings.gitIdentities.editor.field.accountNone': 'Aucun compte',
  'settings.gitIdentities.editor.auth.label': 'Authentification',
  'settings.gitIdentities.editor.auth.account': 'Compte',
  'settings.gitIdentities.editor.auth.ssh': 'SSH',
  'settings.gitIdentities.editor.auth.system': 'Système',
  'settings.gitIdentities.editor.auth.anonymous': 'Anonyme',
  'settings.gitIdentities.editor.auth.accountHint': 'Push et pull avec les identifiants du compte connecté.',
  'settings.gitIdentities.editor.auth.systemHint': 'Utilise les identifiants Git déjà présents sur l\'hôte connecté. OpenChamber ne peut pas vérifier à quel compte ils appartiennent.',
  'settings.gitIdentities.editor.auth.anonymousHint': 'HTTPS public sans identifiants — lecture seule.',
  ...
  'settings.openchamber.git.agentAuthority': 'Appliquer les identités dans les shells de l\'agent',
  'settings.openchamber.git.agentAuthorityAria': 'Appliquer les identités dans les shells de l\'agent',
  'settings.openchamber.git.agentAuthorityInfo': 'Le Git que l\'agent lance lui-même reçoit l\'identité du dépôt au lieu de la configuration de cet ordinateur, et l\'agent est invité à utiliser l\'outil OpenChamber plutôt qu\'un transfert direct. Les dépôts sur Git système gardent la configuration de cet ordinateur. Prend effet au prochain redémarrage d\'OpenCode, jamais dans votre propre terminal.',
...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Ajouter un appareil',
  ...
  'settings.sourceControl.agentAuthority.title': 'Shell de l\'agent',
  'settings.sourceControl.agentAuthority.label': 'Appliquer l\'identité de ce dépôt dans le shell de l\'agent',
  'settings.sourceControl.agentAuthority.info': 'Désactivé signifie que le Git lancé ici par l\'agent garde la configuration de cet ordinateur, et que les transferts directs dans le shell ne sont pas refusés. Prend effet au prochain redémarrage d\'OpenCode.',
  'settings.sourceControl.agentAuthority.machineOff': 'Les identités ne sont pas appliquées dans les shells de l\'agent sur cet ordinateur. Activez-le dans Paramètres → Git.',
