...
export const settingsDict = {
  ...
  'settings.gitIdentities.editor.auth.token': 'Jeton',
  'settings.gitIdentities.editor.auth.anonymous': 'Anonyme',
  'settings.gitIdentities.editor.auth.ssh': 'SSH',
  'settings.gitIdentities.editor.auth.oauthHint': 'Push et pull avec la connexion OAuth du compte.',
  ...
  'settings.gitIdentities.page.signatureOnly': 'Signature seule, d\'une version précédente',
...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Ajouter un appareil',
  ...
  'settings.page.integrations.description': 'Connectez GitHub, GitLab et Linear pour qu’OpenChamber puisse travailler avec vos issues, pull requests et merge requests.',
} as const;
