...
export const settingsDict = {
  ...
  'settings.openchamber.git.agentAuthority': "Répondre à Git dans les shells de l'agent",
  'settings.openchamber.git.agentAuthorityAria': "Répondre à Git dans les shells de l'agent",
  'settings.openchamber.git.agentAuthorityInfo': "Pour les dépôts configurés ici, OpenChamber fournit le compte lié au Git que l'agent lance lui-même et lui demande d'utiliser l'outil OpenChamber plutôt qu'un transfert direct. Les dépôts en Git système et ceux sans transport continuent d'utiliser la configuration de cet ordinateur. Effectif au prochain redémarrage d'OpenCode, jamais dans votre propre terminal.",
...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Ajouter un appareil',
  ...
  'settings.sourceControl.agentAuthority.label': 'Répondre à Git pour ce dépôt',
  'settings.sourceControl.agentAuthority.info': "Désactivé, le Git que l'agent lance ici utilise la configuration de cet ordinateur au lieu du compte lié, et les transferts directs dans le shell ne sont pas refusés. Effectif au prochain redémarrage d'OpenCode.",
  'settings.sourceControl.agentAuthority.machineOff': "Répondre à Git dans les shells de l'agent est désactivé pour cet ordinateur, dans Paramètres → Git.",
