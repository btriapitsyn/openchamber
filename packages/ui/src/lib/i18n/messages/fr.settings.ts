...
export const settingsDict = {
  ...
  'settings.openchamber.visual.field.showExpandedTodoToolsAria': 'Afficher les outils todo étendus',
  'settings.openchamber.visual.field.bash': 'Bash',
  'settings.openchamber.visual.field.editTools': 'Outils d\'édition',
  'settings.openchamber.visual.field.todoList': 'Liste de tâches',
