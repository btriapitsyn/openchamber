...
export const settingsDict = {
  ...
  'settings.providers.freeinference.description': 'Connectez votre clé API FreeInference pour découvrir et utiliser les modèles disponibles.',
  'settings.providers.freeinference.attribution': 'Fourni par le groupe MadSys de Harvard à Harvard SEAS.',
  'settings.providers.freeinference.apiKeyLabel': 'Clé API FreeInference',
  'settings.providers.freeinference.apiKeyPlaceholder': 'Entrez votre clé API FreeInference',
  'settings.providers.freeinference.connect': 'Connecter FreeInference',
  'settings.providers.freeinference.connecting': 'Connexion...',
  'settings.providers.freeinference.syncModels': 'Actualiser les modèles',
  'settings.providers.freeinference.syncing': 'Actualisation...',
  'settings.providers.freeinference.modelsRefreshed': 'Modèles FreeInference actualisés ({count} disponibles)',
  'settings.providers.freeinference.refreshFailed': 'Échec de l\'actualisation des modèles FreeInference',
  'settings.providers.freeinference.infoHint': 'Les modèles sont récupérés dynamiquement depuis l\'API FreeInference pour votre clé authentifiée.',
