...
export const settingsDict = {
  ...
  'settings.notifications.page.events.hint': 'Contrôle les événements de l\'agent qui déclenchent des notifications et des sons. Ces paramètres s\'appliquent aux notifications natives et au système sonore.',
  ...
  'settings.notifications.page.sounds.enableLabel': 'Jouer des sons pour les événements de l\'agent',
  'settings.notifications.page.sounds.enableAria': 'Jouer des sons pour les événements de l\'agent',
  'settings.notifications.page.sounds.hint': 'Joue des signaux audio pour les finitions, erreurs et questions. Utilise les paramètres de focus et d\'événements ci-dessus.',
  'settings.notifications.page.sounds.volumeLabel': 'Volume',
  'settings.notifications.page.sounds.previewAction': 'Aperçu du son',
  'settings.notifications.page.sounds.previewAria': 'Aperçu du son de notification',
