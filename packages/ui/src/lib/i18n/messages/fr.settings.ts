...
export const settingsDict = {
  ...
  'settings.voice.page.field.funasrProtocol': "Protocole FunASR",
  'settings.voice.page.field.funasrProtocolHint': "Choisissez le protocole du serveur actif : Python exige la confirmation de fin is_end ; C++ utilise sa réponse en deux passes ou hors ligne. Ce réglage ne modifie pas le serveur.",
  'settings.voice.page.protocol.python': "Python (confirmation de fin)",
  'settings.voice.page.protocol.cpp2pass': "C++ en deux passes",
  'settings.voice.page.protocol.cppOffline': "C++ hors ligne",
