...
export const settingsDict = {
  ...
  'settings.providers.page.ollamaCloud.help': 'Copiez l’en-tête Cookie complet parmi les en-têtes de requête dans les outils de développement du navigateur sur ollama.com, puis collez-le ici. Seul le cookie de session est enregistré et envoyé : wos-session=... (les anciens comptes peuvent utiliser __Secure-session=...). Les autres cookies de l’en-tête ne sont pas transmis. Il ne s’agit pas d’une clé API ni d’un endpoint Ollama local. OpenChamber n’analyse jamais le stockage des cookies du navigateur.',
