...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.gitIdentities.editor.field.account': '소스 제어 계정',
  'settings.gitIdentities.editor.field.accountNone': '계정 없음',
  'settings.gitIdentities.editor.auth.label': '인증 방식',
  'settings.gitIdentities.editor.auth.account': '계정',
  'settings.gitIdentities.editor.auth.ssh': 'SSH',
  'settings.gitIdentities.editor.auth.system': '시스템',
  'settings.gitIdentities.editor.auth.anonymous': '익명',
  'settings.gitIdentities.editor.auth.accountHint': '연결된 계정 자체의 자격 증명으로 push / pull 합니다.',
  'settings.gitIdentities.editor.auth.systemHint': '연결된 호스트에 이미 있는 Git 자격 증명을 사용합니다. 어느 계정의 것인지 OpenChamber는 확인할 수 없습니다.',
  'settings.gitIdentities.editor.auth.anonymousHint': '자격 증명 없는 공개 HTTPS — 읽기 전용.',
  ...
  'settings.openchamber.git.agentAuthority': '에이전트 셸에서 Git에 응답',
  'settings.openchamber.git.agentAuthorityAria': '에이전트 셸에서 Git에 응답',
  'settings.openchamber.git.agentAuthorityInfo': '여기서 구성한 저장소에서는 에이전트가 직접 실행하는 Git에 연결된 계정을 제공하고, 직접 전송 대신 OpenChamber 도구를 사용하도록 요청합니다. 시스템 Git 저장소와 전송이 없는 저장소는 이 컴퓨터의 설정을 계속 사용합니다. 다음 OpenCode 재시작부터 적용되며, 사용자의 터미널에는 적용되지 않습니다.',
  ...
  'settings.sourceControl.agentAuthority.title': '에이전트 셸',
  'settings.sourceControl.agentAuthority.label': '이 저장소에서 Git에 응답',
  'settings.sourceControl.agentAuthority.info': '끄면 여기서 에이전트가 실행하는 Git이 연결된 계정 대신 이 컴퓨터의 설정을 사용하고, 셸에서의 직접 전송도 거부되지 않습니다. 다음 OpenCode 재시작부터 적용됩니다.',
  'settings.sourceControl.agentAuthority.machineOff': '이 컴퓨터에서는 에이전트 셸에서 Git에 응답하기가 꺼져 있습니다(설정 → Git).',
