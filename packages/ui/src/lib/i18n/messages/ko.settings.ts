...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.gitIdentities.editor.auth.token': '토큰',
  'settings.gitIdentities.editor.auth.anonymous': '익명',
  'settings.gitIdentities.editor.auth.ssh': 'SSH',
  'settings.gitIdentities.editor.auth.oauthHint': '계정의 OAuth 로그인으로 push / pull 합니다.',
  'settings.gitIdentities.editor.auth.tokenHint': '계정의 개인 액세스 토큰으로 push / pull 합니다.',
  ...
  'settings.gitlab.status.tokenRejected': 'GitLab이 이 토큰을 받아들이지 않았습니다. 이 인스턴스의 토큰인지, API 접근 권한이 있는지 확인하세요.',
