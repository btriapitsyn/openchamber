...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.notifications.page.sounds.title': '알림 소리',
  'settings.notifications.page.sounds.enableLabel': '에이전트 이벤트 소리 재생',
  'settings.notifications.page.sounds.enableAria': '에이전트 이벤트 소리 재생',
  'settings.notifications.page.sounds.hint': '완료, 오류, 질문에 대한 오디오 신호를 재생합니다. 위의 포커스 및 이벤트 설정을 사용합니다.',
  'settings.notifications.page.sounds.volumeLabel': '볼륨',
  'settings.notifications.page.sounds.previewAction': '소리 미리보기',
  'settings.notifications.page.sounds.previewAria': '알림 소리 미리보기',
  'settings.notifications.page.sounds.perEventTitle': '이벤트별 소리',
  'settings.notifications.page.sounds.focusOnlyLabel': '포커스가 없을 때만 재생',
  'settings.notifications.page.sounds.focusOnlyAria': '창이 포커스되지 않았을 때만 소리 재생',
  'settings.notifications.page.sounds.focusOnlyHint': '켜짐: 모든 소리가 창이 포커스되지 않았을 때만 재생됩니다. 꺼짐(기본값): 모든 소리는 포커스와 관계없이 재생됩니다.',
