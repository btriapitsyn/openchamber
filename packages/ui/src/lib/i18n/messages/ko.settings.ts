...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.voice.page.field.funasrProtocol': "FunASR 프로토콜",
  'settings.voice.page.field.funasrProtocolHint': "실행 중인 서버에 맞게 선택하세요. Python은 is_end 완료 확인이 필요하고 C++은 2패스 또는 오프라인 응답을 사용합니다. 이 설정은 서버를 변경하지 않습니다.",
  'settings.voice.page.protocol.python': "Python (완료 확인)",
  'settings.voice.page.protocol.cpp2pass': "C++ 2패스",
  'settings.voice.page.protocol.cppOffline': "C++ 오프라인",
