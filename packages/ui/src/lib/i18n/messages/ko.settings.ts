...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.tools.field.serverBrowser': '서버 브라우저',
  'settings.openchamber.tools.field.serverBrowserAria': '서버 브라우저 활성화',
  'settings.openchamber.tools.field.serverBrowserInfo': '이 서버에서 Chrome 브라우저를 실행하여 연결된 창이 응답할 수 없을 때도 에이전트가 브라우징할 수 있게 하고, 어떤 기기에서든 같은 페이지를 보고 조작할 수 있게 합니다. 기본값은 꺼짐이며 즉시 적용됩니다. 끄면 Chrome이 중지되고 해당 세션과 뷰어가 닫힙니다.',
  'settings.openchamber.tools.browserDebugPort.label': '브라우저 CDP 포트',
  'settings.openchamber.tools.browserDebugPort.info': '로컬 MCP 연결에 사용할 포트를 선택하세요. 저장한 설정은 Chrome을 다음에 시작할 때 적용되며 현재 탭은 열린 상태로 유지됩니다.',
  'settings.openchamber.tools.browserDebugPort.automatic': '자동',
  'settings.openchamber.tools.browserDebugPort.fixed': '고정 포트',
  'settings.openchamber.tools.browserDebugPort.input': '고정 CDP 포트',
  'settings.openchamber.tools.browserDebugPort.invalid': '1부터 65535까지의 정수를 입력하세요.',
  'settings.openchamber.tools.browserDebugPort.save': '포트 저장',
  'settings.openchamber.tools.browserDebugPort.configuredAutomatic': '설정된 포트: 자동',
  'settings.openchamber.tools.browserDebugPort.configuredFixed': '설정된 포트: {port}',
  'settings.openchamber.tools.browserDebugPort.loading': '브라우저 상태 확인 중…',
  'settings.openchamber.tools.browserDebugPort.unavailable': '브라우저 상태를 확인할 수 없습니다.',
  'settings.openchamber.tools.browserDebugPort.stopped': 'Chrome이 실행 중이 아닙니다.',
  'settings.openchamber.tools.browserDebugPort.active': '사용 중인 포트: {port}',
  'settings.openchamber.tools.browserDebugPort.pending': '저장한 포트는 Chrome을 다음에 시작할 때 적용됩니다.',
  'settings.openchamber.tools.browserDebugPort.refresh': '상태 새로고침',
  'settings.openchamber.tools.browserDebugPort.copy': '브라우저 URL 복사',
  'settings.openchamber.tools.browserDebugPort.copied': '브라우저 URL을 복사했습니다',
  'settings.openchamber.tools.browserDebugPort.copyFailed': '브라우저 URL을 복사하지 못했습니다.',
  'settings.openchamber.tools.browserDebugPort.connectionInfo': '이 루프백 주소는 서버 컴퓨터의 주소입니다. 해당 컴퓨터에서 --browserUrl을 지정하여 MCP를 실행하거나 직접 설정한 SSH 터널을 사용하세요. 직접 MCP 연결은 "제어권 가져오기"를 사용하지 않습니다.',
