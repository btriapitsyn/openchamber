...
export const settingsDict = {
  ...
  'settings.providers.page.ollamaCloud.help': 'ollama.com의 브라우저 개발자 도구에서 요청 헤더의 전체 Cookie 헤더를 복사해 여기에 붙여 넣으세요. 저장되고 전송되는 것은 세션 쿠키뿐입니다: wos-session=...(이전 계정은 __Secure-session=...을 사용할 수 있음). 헤더의 다른 쿠키는 전달되지 않습니다. 이는 로컬 Ollama API 키나 엔드포인트가 아닙니다. OpenChamber는 브라우저 쿠키 저장소를 검색하지 않습니다.',
