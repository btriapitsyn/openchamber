...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.providers.freeinference.description': 'FreeInference API 키를 연결하여 사용 가능한 모델을 탐색하고 사용하세요.',
  'settings.providers.freeinference.attribution': 'Harvard SEAS의 Harvard MadSys Group에서 제공합니다.',
  'settings.providers.freeinference.apiKeyLabel': 'FreeInference API 키',
  'settings.providers.freeinference.apiKeyPlaceholder': 'FreeInference API 키 입력',
  'settings.providers.freeinference.connect': 'FreeInference 연결',
  'settings.providers.freeinference.connecting': '연결 중...',
  'settings.providers.freeinference.syncModels': '모델 새로고침',
  'settings.providers.freeinference.syncing': '새로고치는 중...',
  'settings.providers.freeinference.modelsRefreshed': 'FreeInference 모델이 새로고침되었습니다 ({count}개 사용 가능)',
  'settings.providers.freeinference.refreshFailed': 'FreeInference 모델 새로고침 실패',
  'settings.providers.freeinference.infoHint': '인증된 키에 맞춰 FreeInference API에서 모델을 동적으로 가져옵니다.',
