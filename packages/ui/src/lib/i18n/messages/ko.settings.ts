...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.visual.field.activityColorCoding': '도구 및 활동 색상 구분',
  'settings.openchamber.visual.field.activityColorCodingAria': '도구 및 활동 행 색상 구분',
  'settings.openchamber.visual.field.activityColorCodingHint': '파일 편집, 셸 명령, 검색, 생각 등 도구와 활동 행에 테마 강조색을 지정합니다. 끄면 단일 중립 색상이 사용됩니다.',
