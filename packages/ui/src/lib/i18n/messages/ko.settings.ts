...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.git.agentAuthority': '에이전트 셸에서 아이덴티티 적용',
  'settings.openchamber.git.agentAuthorityAria': '에이전트 셸에서 아이덴티티 적용',
  'settings.openchamber.git.agentAuthorityInfo': '에이전트가 직접 실행하는 Git은 이 컴퓨터의 설정 대신 저장소의 아이덴티티를 받고, 직접 전송 대신 OpenChamber 도구를 사용하도록 요청받습니다. 시스템 Git을 쓰는 저장소는 이 컴퓨터의 설정을 유지합니다. 다음 OpenCode 재시작부터 적용되며, 본인의 터미널에는 적용되지 않습니다.',
  ...
  'settings.sourceControl.agentAuthority.label': '이 저장소의 아이덴티티를 에이전트 셸에서 적용',
  'settings.sourceControl.agentAuthority.info': '끄면 에이전트가 여기서 실행하는 Git은 이 컴퓨터의 설정을 유지하고, 셸에서의 직접 전송도 거부되지 않습니다. 다음 OpenCode 재시작부터 적용됩니다.',
  'settings.sourceControl.agentAuthority.machineOff': '이 컴퓨터에서는 에이전트 셸에 아이덴티티를 적용하지 않습니다. 설정 → Git에서 켜세요.',
