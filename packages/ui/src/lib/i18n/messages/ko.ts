...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.scheduledTasks.editor.time.periodAria': '오전/오후',
  ...
  'multirun.launcher.baseBranch.info': '모델마다 이 베이스 브랜치에서 새 브랜치를 만듭니다',
  ...
  'sessions.sidebar.dialogs.deleteResult.removedFromDate': '{dateLabel}에서 모든 세션을 제거했습니다.',
  ...
  'sessions.sidebar.group.pr.checksPassed': '체크 {success}/{total}개 통과',
  ...
  'sessions.sidebar.group.empty.noArchivedSessions': '아직 보관된 세션이 없습니다.',
  ...
  'sessions.sidebar.group.actions.newDraftInGroupAria': '{label}에 새 드래프트 세션 생성',
  ...
  'sessions.sidebar.grouping.archivedDescription': '보관되었거나 할당되지 않은 세션',
  ...
  'sessions.sidebar.folderItem.newSessionAria': '{folderName}에 새 세션 생성',
  'sessions.sidebar.folderItem.newSubfolderAria': '{folderName}에 새 하위 폴더 생성',
  'sessions.sidebar.folderItem.newSubfolder': '새 하위 폴더',
  'sessions.sidebar.folderItem.renameAria': '{folderName} 폴더 이름 변경',
  'sessions.sidebar.folderItem.deleteArchivedInFolderAria': '{folderName} 폴더의 보관된 세션 삭제',
  'sessions.sidebar.folderItem.deleteFolderAria': '폴더 {folderName} 삭제',
  'sessions.sidebar.folderItem.emptyFolder': '빈 폴더',
  ...
  'sessions.sidebar.sessionDialogs.directory.errorOpenTitle': '디렉터리 열기 실패',
  'sessions.sidebar.sessionDialogs.directory.errorOpenDescription': '데스크톱에서 파일 접근 권한을 부여할 수 없습니다.',
  ...
  'sessions.sidebar.sessionDialogs.worktree.attachedArchived': '연결된 워크트리가 보관되었습니다.',
  'sessions.sidebar.sessionDialogs.worktree.attachedArchivedPlural': '연결된 워크트리가 보관되었습니다.',
  ...
  'gitView.branch.noLocalBranches': '로컬 브랜치 없음',
  'gitView.branch.noRemoteBranches': '리모트 브랜치 없음',
  ...
  'gitView.branch.updateDescriptionPrefix': '현재 브랜치를 다음 브랜치로 업데이트합니다:',
  ...
  'gitView.conflict.loading': '충돌 상세 정보 로드 중…',
  ...
  'gitView.empty.cleanDescription': '모든 변경 사항이 커밋되었습니다.',
  'gitView.empty.cleanTitle': '워킹 트리가 깨끗합니다',
  'gitView.empty.pullBehindPlural': '커밋 {count}개 가져오기',
  'gitView.empty.pullBehindSingle': '커밋 {count}개 가져오기',
  'gitView.header.identityTooltip': 'Git 작성자 정보',
  'gitView.header.noIdentity': '작성자 정보 없음',
  ...
  'gitView.integrate.showingFirstCommits': '첫 커밋 표시 중',
  ...
  'gitView.stash.stepStash': '커밋하지 않은 변경 사항 stash 처리',
  ...
  'gitView.pr.actions.openChecksAria': '실패한 체크 열기',
  ...
  'gitView.pr.actions.resolveFailedChecksAria': '실패한 체크를 에이전트에 보내기',
  'gitView.pr.actions.savePr': 'PR 저장',
  'gitView.pr.actions.savePrAria': 'PR 변경 사항 저장',
  'gitView.pr.actions.sendCommentToAgent': '댓글을 에이전트에 보내기',
  'gitView.pr.actions.sendCommentToAgentAria': '이 댓글을 에이전트에 보내기',
  'gitView.pr.actions.sendToAgent': '에이전트에 보내기',
  'gitView.pr.actions.shareComments': '댓글 공유',
  'gitView.pr.actions.shareCommentsAria': 'PR 댓글을 에이전트에 보내기',
  ...
  'gitView.pr.placeholder.additionalContext': '제약 사항, 배포 메모, 리뷰어에게 필요한 컨텍스트…',
  ...
  'gitView.toast.checkedOut': '{name} 체크아웃됨',
  ...
  'gitView.toast.copyFailed': '복사 실패',
  'gitView.toast.createBranchFailed': '브랜치 생성 실패',
  'gitView.toast.createCommitFailed': '커밋 생성 실패',
  'gitView.toast.createdBranch': '브랜치 {name} 생성됨',
  ...
  'gitView.toast.renamedBranch': '{oldName}을(를) {newName}(으)로 이름 변경했습니다',
  ...
  'contextUsage.tooltip.usedTokens': '사용한 토큰: {tokens}',
  ...
  'diffView.image.new': '새 이미지',
  'diffView.image.originalAlt': '원본: {path}',
  'diffView.image.modifiedAlt': '수정됨: {path}',
  ...
  'rightSidebar.contextNotesTodo.toast.sentToNewSession': 'Todo를 새 세션으로 보냄',
  'rightSidebar.contextNotesTodo.toast.sentToNewWorktreeSession': 'Todo를 새 워크트리 세션으로 보냄',
  ...
  'inlineComment.actions.editComment': '댓글 편집',
  ...
  'header.services.noRateLimits': '사용 가능한 레이트 리밋 없음',
  'header.services.noRateLimitsReported': '보고된 레이트 리밋 없음',
  ...
  'terminalView.stream.processExitedWithCode': ' 코드 {exitCode}',
  ...
  'terminalView.error.startSessionFailed': '터미널 세션 시작 실패',
  'terminalView.error.restartFailed': '터미널 재시작 실패',
  'terminalView.error.sendInputFailed': '입력 전송 실패',
  ...
  'terminalView.actions.hardRestartTitle': '강제 종료 후 새 세션 생성',
  'terminalView.quickKeys.escape': 'Esc',
  'terminalView.quickKeys.tabAria': 'Tab',
  'terminalView.quickKeys.controlLabel': 'Ctrl',
  'terminalView.quickKeys.controlModifierAria': 'Control 보조 키',
  'terminalView.quickKeys.commandModifierAria': 'Command 보조 키',
  ...
  'directoryExplorerDialog.toast.failedToOpenDirectory': '디렉터리 열기 실패',
  'directoryExplorerDialog.toast.desktopCouldNotGrantAccess': '데스크톱에서 파일 접근 권한을 부여할 수 없습니다.',
  ...
  'directoryTree.actions.createNewDirectory': '새 디렉터리 생성',
  ...
  'helpDialog.item.createNewSession': '새 세션 생성',
  'helpDialog.item.createNewWorktreeDraft': '새 워크트리 드래프트 생성',
  'helpDialog.item.focusChatInput': '채팅 입력에 포커스',
  ...
  'helpDialog.item.toggleTerminalExpanded': '터미널 확장 전환',
  ...
  'header.changes.availableAria': '변경 사항 있음',
  'session.githubIssuePicker.error.noActiveProject': '활성 프로젝트 없음',
  'session.githubIssuePicker.error.runtimeUnavailable': 'GitHub 런타임 API를 사용할 수 없음',
  'session.githubIssuePicker.error.notConnected': 'GitHub에 연결되지 않음',
  'session.githubIssuePicker.error.repoNotResolvable': '레포지토리를 확인할 수 없음',
  'session.githubIssuePicker.error.repoMustBeGithub': 'origin 리모트는 GitHub URL이어야 합니다',
  'session.githubIssuePicker.error.issueNotFound': '이슈를 찾을 수 없음',
  'session.githubIssuePicker.error.noModelSelected': '선택된 모델 없음',
  'session.githubIssuePicker.toast.loadMoreFailed': '이슈 추가 로드 실패',
  'session.githubIssuePicker.toast.loadIssueDetailsFailed': '이슈 상세 정보 로드 실패',
  'session.githubIssuePicker.toast.sendContextFailed': '이슈 컨텍스트 전송 실패',
  'session.githubIssuePicker.toast.sessionCreated': '이슈에서 세션이 생성되었습니다',
  'session.githubIssuePicker.toast.startSessionFailed': '세션 시작 실패',
  'session.githubIssuePicker.title.select': 'GitHub 이슈 연결',
  'session.githubIssuePicker.title.createSession': 'GitHub 이슈에서 새 세션 생성',
  ...
  'session.githubIssuePicker.searchPlaceholder': '제목이나 #123으로 검색하거나 이슈 URL 붙여넣기',
  ...
  'session.githubIssuePicker.empty.noOpenIssuesFound': '열린 이슈 없음',
  ...
  'session.githubIssuePicker.actions.createInWorktree': '워크트리에 생성',
  'session.githubIssuePicker.actions.openRepo': '레포지토리 열기',
  'session.githubIssuePicker.actions.refresh': '새로고침',
  'session.githubPrPicker.error.noActiveProject': '활성 프로젝트 없음',
  'session.githubPrPicker.error.runtimeUnavailable': 'GitHub 런타임 API를 사용할 수 없음',
  'session.githubPrPicker.error.notConnected': 'GitHub에 연결되지 않음',
  'session.githubPrPicker.error.prNotFound': 'PR을 찾을 수 없음',
  'session.githubPrPicker.error.repoNotResolvable': '레포지토리를 확인할 수 없음',
  'session.githubPrPicker.error.repoMustBeGithub': 'origin 리모트는 GitHub URL이어야 합니다',
  'session.githubPrPicker.toast.loadMoreFailed': 'PR 추가 로드 실패',
  'session.githubPrPicker.toast.loadDetailsFailed': 'PR 상세 정보 로드 실패',
  'session.githubPrPicker.title': 'GitHub PR 연결',
  'session.githubPrPicker.description': '이 메시지에 리뷰 컨텍스트로 첨부할 PR을 선택하세요.',
  'session.githubPrPicker.searchPlaceholder': '제목이나 #123으로 검색하거나 PR URL 붙여넣기',
  'session.githubPrPicker.includeDiffAria': '첨부 컨텍스트에 PR diff 포함',
  'session.githubPrPicker.includeDiff': 'PR diff 포함',
  ...
  'session.githubPrPicker.empty.noPullRequestsFound': 'PR 없음',
  'session.githubPrPicker.empty.noOpenPullRequestsFound': '열린 PR 없음',
  'session.githubPrPicker.loading.pullRequests': 'PR 로드 중…',
  ...
  'session.newWorktree.loadingBranches': '브랜치 로드 중…',
  'session.newWorktree.noBranchesFound': '브랜치 없음',
  'session.newWorktree.matchingBranches': '일치하는 브랜치',
  'session.newWorktree.noMatchingBranches': '일치하는 브랜치 없음',
  'session.newWorktree.localBranches': '로컬 브랜치',
  'session.newWorktree.remoteBranches': '리모트 브랜치',
  'session.newWorktree.otherLocalBranches': '다른 로컬 브랜치',
  'session.newWorktree.otherRemoteBranches': '다른 리모트 브랜치',
  ...
  'session.newWorktree.sourceBranch': '소스 브랜치',
  'session.newWorktree.selectSourceBranch': '소스 브랜치 선택',
  'session.newWorktree.selectSourceBranchPlaceholder': '소스 브랜치 선택...',
  ...
  'session.newWorktree.error.noModelSelected': '선택된 모델 없음',
  'session.newWorktree.error.noActiveProject': '활성 프로젝트 없음',
  ...
  'session.newWorktree.error.sendGitHubContextFailed': 'GitHub 컨텍스트 전송 실패',
  'session.newWorktree.error.createWorktreeFailed': '워크트리 생성 실패',
  'session.newWorktree.toast.sessionFromIssue': '이슈에서 세션이 생성되었습니다',
  'session.newWorktree.toast.sessionFromPr': 'PR에서 세션이 생성되었습니다',
  'session.newWorktree.toast.worktreeCreated': '워크트리 생성됨',
  'session.newWorktree.toast.worktreeCreatedDescription': '{target} - 백그라운드에서 준비 중',
  ...
  'session.githubIntegration.connect.title': 'GitHub 연결',
  'session.githubIntegration.connect.description': '이슈 또는 PR을 연결해 워크트리 상세 정보를 자동 입력합니다',
  ...
  'session.githubIntegration.empty.noPullRequestsFound': 'PR 없음',
  ...
  'session.githubIntegration.includeDiffAria': '세션 컨텍스트에 PR diff 포함',
  'session.githubIntegration.includeDiff': 'PR diff 포함',
  'session.githubIntegration.error.notConnected': 'GitHub에 연결되지 않음',
  'session.githubIntegration.error.loadDataFailed': '데이터 로드 실패',
  'session.githubIntegration.validation.branchAlreadyCheckedOut': '브랜치가 이미 워크트리에서 체크아웃되어 있습니다',
  'session.githubIntegration.validation.failed': '검증 실패',
  'chat.fileAttachment.toast.attachFailed': '파일 첨부 실패',
  'chat.fileAttachment.toast.someFilesSkipped': '일부 파일을 건너뛰었습니다:\n{summary}',
  'chat.fileAttachment.toast.vscodePickFailed': 'VS Code에서 파일 선택 실패',
  ...
  'chat.timeline.actions.forkFromHere': '여기서 분기',
  ...
  'chat.fileMentionAutocomplete.searchMoreAgents': '입력해서 더 많은 에이전트 검색',
  'chat.fileMentionAutocomplete.empty': '일치하는 항목 없음',
  'chat.queuedMessage.attachments': '+파일 {count}개',
  ...
  'chat.messageBody.actions.fork': '여기서 분기',
  ...
  'chat.messageBody.toast.imageSaved': '이미지가 저장되었습니다',
  ...
  'chat.chatInput.actions.sendMessageAria': '메시지 보내기',
  ...
  'chat.chatInput.permissionAutoAccept.disable': '권한 자동 승인 비활성화',
  'chat.chatInput.permissionAutoAccept.enable': '권한 자동 승인 활성화',
  'chat.chatInput.permissionAutoAccept.on': '권한 auto-accept: on',
  'chat.chatInput.permissionAutoAccept.off': '권한 auto-accept: off',
  'chat.chatInput.linked.byAuthor': '{author} 작성',
  ...
  'chat.chatInput.placeholder.chat': '@로 파일/에이전트, /로 명령, !로 shell 입력',
  ...
  'chat.chatInput.toast.reviewFailed': '변경 사항 리뷰 실패',
  ...
  'chat.chatInput.toast.messageSendFailed': '메시지 전송 실패. 첨부 파일을 복원했습니다.',
  ...
  'chat.chatInput.toast.vscodePickFailed': 'VS Code에서 파일 선택 실패',
  'chat.chatInput.toast.openSessionFirst': '먼저 세션을 여세요',
  'chat.chatInput.toast.togglePermissionAutoAcceptFailed': '권한 자동 승인 전환 실패',
  'chat.chatInput.reviewComments': '리뷰 댓글:',
  ...
  'chat.chatInput.drop.insertMention': '드롭하여 멘션으로 삽입',
  'chat.chatInput.drop.attachFiles': '파일을 여기에 드롭하여 첨부',
  'chat.chatInput.fileFallback': '파일',
  'chat.mobileStatus.editProjects.title': '프로젝트 편집',
  ...
  'chat.mobileStatus.swipeHint': '← 여기서 스와이프하여 사이드바 열기 →',
  ...
  'chat.toolOutputDialog.mermaid.loadFailed': 'Mermaid 다이어그램을 로드할 수 없습니다.',
  ...
  'chat.permissionToast.actions.denyAria': '권한 거부',
  'chat.permissionToast.actions.denyAriaWithSession': '{session} 권한 거부',
  ...
  'chat.modelControls.noAgentSelected': '선택된 에이전트 없음',
  ...
  'chat.messageBody.subtask.hidePrompt': '프롬프트 숨기기',
  'chat.messageBody.subtask.showPrompt': '프롬프트 표시',
  'chat.messageBody.subtask.openSession': '하위 작업 세션 열기',
  'chat.messageBody.shellCommand.title': 'Shell 명령',
  'chat.messageBody.shellCommand.hideOutput': '출력 숨기기',
  'chat.messageBody.shellCommand.showOutput': '출력 표시',
  ...
  'quickOpenDialog.empty.noMatchingFiles': '일치하는 파일 없음',
  'quickOpenDialog.empty.noMatchingRecentFiles': '최근 파일 없음',
  ...
  'openCodeStatusDialog.empty.noData': '데이터 없음',
  'openCodeStatusDialog.toast.copiedTitle': '복사됨',
  'openCodeStatusDialog.toast.copiedDescription': '상태가 클립보드에 복사되었습니다',
  'openCodeStatusDialog.toast.copyFailed': '상태 복사 실패',
  'saveProjectPlanDialog.title': '프로젝트 플랜 저장',
  'saveProjectPlanDialog.description': '이 플랜을 프로젝트에 Markdown 파일로 저장합니다.',
  'saveProjectPlanDialog.field.title': '제목',
  'saveProjectPlanDialog.field.titlePlaceholder': '플랜 제목',
  ...
  'branchPickerDialog.state.noProjectSelected': '선택된 프로젝트 없음',
  'branchPickerDialog.state.loadingBranches': '브랜치 로드 중…',
  'branchPickerDialog.state.noMatchingBranches': '일치하는 브랜치 없음',
  'branchPickerDialog.state.noBranchesFound': '브랜치 없음',
  ...
  'branchPickerDialog.actions.confirmDeleteAria': '브랜치 삭제 확인',
  'branchPickerDialog.actions.cancelDeleteAria': '브랜치 삭제 취소',
  ...
  'branchPickerDialog.toast.failedToRenameBranch': '브랜치 이름 변경 실패',
  ...
  'branchPickerDialog.toast.failedToDeleteBranch': '브랜치 삭제 실패',
  'branchPickerDialog.toast.worktreeCreated': '워크트리 생성됨',
  'branchPickerDialog.toast.failedToCreateWorktree': '워크트리 생성 실패',
  'branchPickerDialog.error.failedToLoad': '브랜치 로드 실패',
  'branchPickerDialog.error.renameRejected': '이름 변경이 거부되었습니다',
  'branchPickerDialog.error.renameFailed': '브랜치 이름 변경 실패',
  'branchPickerDialog.error.deleteRejected': '삭제가 거부되었습니다',
  'branchPickerDialog.error.deleteFailed': '브랜치 삭제 실패',
  'branchPickerDialog.error.createWorktreeFailed': '워크트리 생성 실패',
  'projectEditDialog.title': '프로젝트 편집',
  ...
  'agentManager.sidebar.toast.deletedGroup': '"{group}" 삭제됨',
  ...
  'agentManager.empty.baseBranch.description': '{branch}에서 새 브랜치를 생성합니다',
  'agentManager.empty.setupCommands.label': '셋업 명령',
  'agentManager.empty.setupCommands.configured': '{count}개 설정됨',
  'agentManager.empty.setupCommands.description': '각 새 워크트리에서 명령을 실행합니다. 프로젝트 루트에는 $ROOT_PROJECT_PATH를 사용하세요.',
  ...
  'agentManager.empty.toast.attachedSingle': '파일 {count}개 첨부됨',
  'agentManager.empty.toast.attachedPlural': '파일 {count}개 첨부됨',
  'agentManager.empty.toast.failedToCreateGroup': '에이전트 그룹 생성 실패',
  ...
  'openInApp.toast.pathCopied': '경로가 클립보드에 복사되었습니다',
  ...
  'projectActions.actions.runNamedAria': '{name} 실행',
  'projectActions.actions.stopNamedAria': '{name} 중지',
  'projectActions.label.fallbackAction': '작업',
  'projectActions.toast.openedUrlFromOutput': '작업 출력의 URL을 열었습니다',
  'projectActions.toast.openedForwardedUrl': '포워딩된 URL을 열었습니다',
  'projectActions.toast.openedActionUrl': '작업 URL을 열었습니다',
  'projectActions.error.noActiveDirectory': '활성 디렉터리 없음',
  'projectActions.error.noActiveDirectoryForAction': '작업에 사용할 활성 디렉터리 없음',
  'projectActions.error.failedToCreateTerminalSession': '터미널 세션 생성 실패',
  'projectActions.error.invalidCustomUrlFormat': '유효하지 않은 사용자 지정 URL 형식',
  'projectActions.error.selectedDesktopSshForwardUnavailable': '선택한 데스크톱 SSH 포워딩을 사용할 수 없음',
  'projectActions.error.failedToRunAction': '작업 실행 실패',
  ...
  'mcpDropdown.empty.configureInConfig': 'OpenCode 설정에서 MCP 서버를 설정하세요.',
  'sessionAuth.error.rateLimitTitle': '시도 횟수가 너무 많음',
  'sessionAuth.error.networkTitle': '서버에 연결할 수 없음',
  'sessionAuth.error.rateLimitDescriptionSingle': '다시 시도하기 전에 {minutes}분 기다려 주세요.',
  'sessionAuth.error.rateLimitDescriptionPlural': '다시 시도하기 전에 {minutes}분 기다려 주세요.',
  'sessionAuth.error.networkDescription': 'UI 세션을 확인할 수 없습니다. 서비스가 실행 중인지 확인하고 다시 시도하세요.',
  'sessionAuth.error.retry': '다시 시도',
  'sessionAuth.error.passkeySetupFailed': '패스키 설정 실패.',
  'sessionAuth.error.incorrectPassword': '비밀번호가 올바르지 않습니다. 다시 시도하세요.',
  'sessionAuth.error.unexpectedResponse': '서버에서 예상치 못한 응답을 받았습니다.',
  'sessionAuth.error.networkRetry': '네트워크 오류입니다. 연결을 확인하고 다시 시도하세요.',
  ...
  'sessionAuth.toast.passkeyAdded': '패스키가 추가되었습니다',
  'sessionAuth.toast.passkeySetupCanceled': '패스키 설정이 취소되었습니다',
  'desktopHostSwitcher.title': '인스턴스',
  'desktopHostSwitcher.description': '로컬 및 원격 OpenChamber 서버를 전환합니다',
  ...
  'desktopHostSwitcher.sshPhase.reconnecting': '재연결 중',
  'desktopHostSwitcher.sshPhase.resolvingConfig': '설정 확인 중',
  ...
  'desktopHostSwitcher.field.labelPlaceholder': '라벨',
  'desktopHostSwitcher.field.labelOptionalPlaceholder': '라벨(선택 사항)',
  ...
  'desktopHostSwitcher.state.instanceUnreachable': '인스턴스에 연결할 수 없음',
  'desktopHostSwitcher.edit.title': '인스턴스 편집',
  'desktopHostSwitcher.add.title': '인스턴스 추가',
  'desktopHostSwitcher.error.failedToSave': '저장 실패',
  'desktopHostSwitcher.error.failedToLoad': '로드 실패',
  'desktopHostSwitcher.error.invalidUrl': '유효하지 않은 URL(http/https 필요)',
  'desktopHostSwitcher.error.failedToOpenNewWindow': '새 창 열기 실패',
  'desktopHostSwitcher.instance.local': '로컬',
  'desktopHostSwitcher.instance.fallback': '인스턴스',
  'desktopHostSwitcher.startup.title': '기본 SSH 인스턴스를 사용할 수 없음',
  'desktopHostSwitcher.startup.connectingTo': '{host}에 연결 중…',
  'desktopHostSwitcher.startup.failed': '기본 SSH 인스턴스에 연결하지 못했습니다.',
  'desktopHostSwitcher.toast.sshConnected': 'SSH 인스턴스 "{host}"에 연결되었습니다',
  'desktopHostSwitcher.toast.sshFailedToConnect': 'SSH 인스턴스 "{host}" 연결 실패',
  ...
  'goToLineDialog.helper.goToLine': '{line}번째 줄로 이동',
  ...
  'multiRun.branchSelector.status.loadingBranches': '브랜치 로드 중…',
  'multiRun.branchSelector.status.noBranchesFound': '브랜치 없음',
  ...
  'voice.status.conversationModeActiveAria': '대화 모드 활성화됨',
  'onboarding.common.actions.back': '뒤로',
  'onboarding.common.copyToClipboard': '클립보드에 복사',
  'onboarding.common.status.copiedToClipboard': '클립보드에 복사됨',
  'onboarding.chooser.title': 'OpenChamber에 오신 것을 환영합니다',
  'onboarding.chooser.description': '시작하려면 연결 방식을 선택하세요.',
  ...
  'onboarding.localSetup.errors.detectionFailed': '감지 실패',
  ...
  'onboarding.localSetup.actions.checkAndContinue': '설치를 완료했습니다. 확인 후 계속',
  'onboarding.localSetup.helper.checkAndContinue': '클릭하여 OpenCode CLI를 사용할 수 있는지 확인하세요. 성공하면 자동으로 메인 화면으로 이동합니다.',
  ...
  'onboarding.localSetup.actions.connectRemoteServer': '원격 서버에 연결 →',
  'onboarding.localSetup.windows.hintInstallInWsl': 'Windows에서는 최상의 호환성을 위해 WSL에 OpenCode를 설치하고 실행하세요.',
  ...
  'onboarding.remoteConnection.title': '원격 서버에 연결',
  ...
  'onboarding.remoteConnection.field.nameOptional': '이름(선택 사항)',
  'onboarding.remoteConnection.field.namePlaceholder': '내 원격 서버',
  'onboarding.remoteConnection.errors.connectionTestFailed': '연결 테스트 실패',
  'onboarding.remoteConnection.errors.failedToSaveConnection': '연결 저장 실패',
  'onboarding.remoteConnection.status.connectedSuccessfully': '연결 성공({latencyMs}ms)',
  'onboarding.remoteConnection.status.authWarning': '서버에 인증이 필요합니다. 그래도 연결할 수 있습니다.',
  'onboarding.remoteConnection.status.connectionFailed': '연결 실패',
  ...
  'onboarding.remoteConnection.actions.whatToDo': '무엇을 하시겠습니까?',
  ...
  'onboarding.remoteConnection.probe.authMessage': '서버에 인증이 필요합니다. 그래도 연결할 수 있지만 인증 정보를 제공해야 할 수 있습니다.',
  ...
  'onboarding.desktopRecovery.noDefaultConnection.title': '기본 연결 없음',
  'onboarding.desktopRecovery.noDefaultConnection.description': '저장된 기본 연결을 찾을 수 없습니다. 연결 방식을 선택하세요.',
  'onboarding.desktopRecovery.remoteUnreachable.title': '원격 서버에 연결할 수 없음',
  ...
  'vscodeLayout.quota.noRateLimitsAvailable': '사용 가능한 레이트 리밋 없음',
  'vscodeLayout.quota.noRateLimitsReported': '보고된 레이트 리밋 없음',
  'vscodeLayout.quota.actions.rateLimitsAria': '레이트 리밋',
  'vscodeLayout.quota.actions.showUsedAria': '사용된 quota 표시',
  'vscodeLayout.quota.actions.showRemainingAria': '남은 quota 표시',
