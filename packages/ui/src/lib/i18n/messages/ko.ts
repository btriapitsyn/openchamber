...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.group.pr.mergeable': 'Merge 가능',
  'sessions.sidebar.group.pr.mergeState': 'Merge 상태: {state}',
  'sessions.sidebar.group.pr.status.merged': 'merged',
  'sessions.sidebar.group.pr.status.readyToMerge': 'Merge 준비됨',
  'sessions.sidebar.group.pr.status.open': 'PR 열기',
  'sessions.sidebar.group.pr.status.mergeConflicts': 'Merge 충돌',
  'sessions.sidebar.group.pr.status.mergeBlocked': 'Merge 차단됨',
  ...
  'gitView.conflict.resolveCurrentSession': 'Resolve에서 현재 세션으로 열기',
  'gitView.conflict.resolveNewSession': 'Resolve에서 새 세션으로 열기',
  ...
  'gitView.operation.resolveConflictsHint': 'Resolve에서 충돌 해결을 진행하세요.',
  ...
  'gitView.pr.actions.resolveFailedChecks': 'Resolve로 실패한 검사 해결',
  ...
  'gitView.pr.toast.prMerged': 'PR Merge 완료',
  ...
  'gitView.toast.pulledFilesPlural': '리모트 {name}에서 파일 {count}개를 pull했습니다',
  'gitView.toast.pulledFilesSingle': '리모트 {name}에서 파일 {count}개를 pull했습니다',
