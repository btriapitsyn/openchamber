...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.voice.page.field.funasrProtocol': "Protokół FunASR",
  'settings.voice.page.field.funasrProtocolHint': "Wybierz protokół działającego serwera: Python wymaga potwierdzenia zakończenia is_end; C++ używa odpowiedzi dwuprzebiegowej lub offline. To ustawienie nie zmienia serwera.",
  'settings.voice.page.protocol.python': "Python (potwierdzenie końca)",
  'settings.voice.page.protocol.cpp2pass': "C++ dwuprzebiegowy",
