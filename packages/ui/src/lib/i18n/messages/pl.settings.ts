...
export const settingsDict = {
  ...
  'settings.openchamber.tools.field.serverBrowser': 'Przeglądarka serwera',
  'settings.openchamber.tools.field.serverBrowserAria': 'Włącz przeglądarkę serwera',
  'settings.openchamber.tools.field.serverBrowserInfo': 'Uruchamia przeglądarkę Chrome na tym serwerze, aby agenci mogli przeglądać strony nawet gdy żadne połączone okno nie może odpowiedzieć, i abyś mógł oglądać oraz sterować tymi samymi stronami z dowolnego urządzenia. Domyślnie wyłączone, działa natychmiast; wyłączenie zatrzymuje Chrome i zamyka jego sesje oraz obserwujących.',
  'settings.openchamber.tools.browserDebugPort.label': 'Port CDP przeglądarki',
  'settings.openchamber.tools.browserDebugPort.info': 'Wybierz port lokalnych połączeń MCP. Zapisana zmiana zostanie zastosowana przy następnym uruchomieniu Chrome. Bieżące karty pozostaną otwarte.',
  'settings.openchamber.tools.browserDebugPort.automatic': 'Automatyczny',
  'settings.openchamber.tools.browserDebugPort.fixed': 'Stały port',
  'settings.openchamber.tools.browserDebugPort.input': 'Stały port CDP',
  'settings.openchamber.tools.browserDebugPort.invalid': 'Wpisz liczbę całkowitą od 1 do 65535.',
  'settings.openchamber.tools.browserDebugPort.save': 'Zapisz port',
  'settings.openchamber.tools.browserDebugPort.configuredAutomatic': 'Skonfigurowany port: automatyczny',
  'settings.openchamber.tools.browserDebugPort.configuredFixed': 'Skonfigurowany port: {port}',
  'settings.openchamber.tools.browserDebugPort.loading': 'Sprawdzanie stanu przeglądarki…',
  'settings.openchamber.tools.browserDebugPort.unavailable': 'Stan przeglądarki jest niedostępny.',
  'settings.openchamber.tools.browserDebugPort.stopped': 'Chrome nie jest uruchomiony.',
  'settings.openchamber.tools.browserDebugPort.active': 'Aktywny port: {port}',
  'settings.openchamber.tools.browserDebugPort.pending': 'Zapisany port zostanie zastosowany przy następnym uruchomieniu Chrome.',
  'settings.openchamber.tools.browserDebugPort.refresh': 'Odśwież stan',
  'settings.openchamber.tools.browserDebugPort.copy': 'Kopiuj URL przeglądarki',
  'settings.openchamber.tools.browserDebugPort.copied': 'Skopiowano URL przeglądarki',
  'settings.openchamber.tools.browserDebugPort.copyFailed': 'Nie udało się skopiować adresu URL przeglądarki.',
  'settings.openchamber.tools.browserDebugPort.connectionInfo': 'Ten adres pętli zwrotnej należy do komputera serwera. Uruchom na nim MCP z opcją --browserUrl lub użyj własnego tunelu SSH. Bezpośrednie połączenia MCP nie korzystają z funkcji Przejmij kontrolę.',
