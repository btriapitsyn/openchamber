...
export const settingsDict = {
  ...
  'settings.openchamber.git.agentAuthority': 'Stosuj tożsamości w powłokach agenta',
  'settings.openchamber.git.agentAuthorityAria': 'Stosuj tożsamości w powłokach agenta',
  'settings.openchamber.git.agentAuthorityInfo': 'Git uruchamiany przez samego agenta otrzymuje tożsamość repozytorium zamiast ustawień tego komputera, a agent jest proszony o użycie narzędzia OpenChamber zamiast bezpośredniego transferu. Repozytoria na systemowym Git zachowują ustawienia tego komputera. Działa od następnego restartu OpenCode i nigdy w twoim własnym terminalu.',
...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.sourceControl.agentAuthority.label': 'Stosuj tożsamość tego repozytorium w powłoce agenta',
  'settings.sourceControl.agentAuthority.info': 'Wyłączone oznacza, że Git uruchamiany tu przez agenta zachowuje ustawienia tego komputera, a bezpośrednie transfery w powłoce nie są odrzucane. Działa od następnego restartu OpenCode.',
  'settings.sourceControl.agentAuthority.machineOff': 'Tożsamości nie są stosowane w powłokach agenta na tym komputerze. Włącz to w Ustawienia → Git.',
