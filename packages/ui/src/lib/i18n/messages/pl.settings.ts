...
export const settingsDict = {
  ...
  'settings.providers.page.ollamaCloud.help': 'Skopiuj pełny nagłówek Cookie z nagłówków żądania w narzędziach deweloperskich przeglądarki na ollama.com i wklej go tutaj. Zapisane i wysyłane jest tylko cookie sesji: wos-session=... (starsze konta mogą używać __Secure-session=...). Pozostałe cookie w nagłówku nie są przekazywane. To nie jest Twój lokalny klucz API ani endpoint Ollama. OpenChamber nigdy nie skanuje plików cookie przeglądarki.',
