...
export const settingsDict = {
  ...
  'settings.gitIdentities.editor.field.account': 'Konto kontroli źródeł',
  'settings.gitIdentities.editor.field.accountNone': 'Bez konta',
  'settings.gitIdentities.editor.auth.label': 'Uwierzytelnianie',
  ...
  'settings.gitIdentities.editor.auth.anonymous': 'Anonimowo',
  'settings.gitIdentities.editor.auth.accountHint': 'Push i pull z poświadczeniami połączonego konta.',
  'settings.gitIdentities.editor.auth.systemHint': 'Używa poświadczeń Git, które połączony host już ma. OpenChamber nie może sprawdzić, do którego konta należą.',
  'settings.gitIdentities.editor.auth.anonymousHint': 'Publiczne HTTPS bez poświadczeń — tylko do odczytu.',
  ...
  'settings.openchamber.git.agentAuthority': 'Odpowiadaj Gitowi w powłokach agenta',
  'settings.openchamber.git.agentAuthorityAria': 'Odpowiadaj Gitowi w powłokach agenta',
  'settings.openchamber.git.agentAuthorityInfo': 'W repozytoriach skonfigurowanych tutaj OpenChamber podaje powiązane konto Gitowi uruchamianemu przez agenta i prosi go o użycie narzędzia OpenChamber zamiast bezpośredniego transferu. Repozytoria z systemowym Gitem i bez transportu nadal korzystają z ustawień tego komputera. Działa po następnym restarcie OpenCode i nigdy w twoim własnym terminalu.',
...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.sourceControl.accounts.inUse': 'W użyciu',
  ...
  'settings.sourceControl.agentAuthority.title': 'Powłoka agenta',
  'settings.sourceControl.agentAuthority.label': 'Odpowiadaj Gitowi w tym repozytorium',
  'settings.sourceControl.agentAuthority.info': 'Gdy to jest wyłączone, Git uruchamiany tu przez agenta korzysta z ustawień tego komputera zamiast powiązanego konta, a bezpośrednie transfery w powłoce nie są odrzucane. Działa po następnym restarcie OpenCode.',
  'settings.sourceControl.agentAuthority.machineOff': 'Odpowiadanie Gitowi w powłokach agenta jest wyłączone dla tego komputera, w Ustawieniach → Git.',
