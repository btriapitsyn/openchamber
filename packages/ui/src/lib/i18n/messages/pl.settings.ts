...
export const settingsDict = {
  ...
  'settings.openchamber.visual.field.activityColorCoding': 'Kolorowanie narzędzi i aktywności',
  'settings.openchamber.visual.field.activityColorCodingAria': 'Kolorowanie wierszy narzędzi i aktywności',
  'settings.openchamber.visual.field.activityColorCodingHint': 'Nadaje każdemu typowi wiersza narzędzia i aktywności własny kolor akcentowy motywu — zmiany w plikach, polecenia powłoki, wyszukiwania, myślenie i inne. Wyłącz, aby użyć jednego neutralnego odcienia.',
