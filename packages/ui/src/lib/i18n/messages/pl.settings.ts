...
export const settingsDict = {
  ...
  'settings.providers.freeinference.description': 'Połącz swój klucz API FreeInference, aby wykrywać i używać dostępnych modeli.',
  'settings.providers.freeinference.attribution': 'Udostępniane przez Harvard MadSys Group w Harvard SEAS.',
  'settings.providers.freeinference.apiKeyLabel': 'Klucz API FreeInference',
  'settings.providers.freeinference.apiKeyPlaceholder': 'Wprowadź klucz API FreeInference',
  'settings.providers.freeinference.connect': 'Połącz FreeInference',
  'settings.providers.freeinference.connecting': 'Łączenie...',
  'settings.providers.freeinference.syncModels': 'Odśwież modele',
  'settings.providers.freeinference.syncing': 'Odświeżanie...',
  'settings.providers.freeinference.modelsRefreshed': 'Odświeżono modele FreeInference (dostępne: {count})',
  'settings.providers.freeinference.refreshFailed': 'Nie udało się odświeżyć modeli FreeInference',
  'settings.providers.freeinference.infoHint': 'Modele są dynamicznie pobierane z interfejsu API FreeInference dla uwierzytelnionego klucza.',
