...
export const settingsDict = {
  ...
  'settings.gitIdentities.editor.auth.oauthHint': 'Push i pull z logowaniem OAuth konta.',
  'settings.gitIdentities.editor.auth.tokenHint': 'Push i pull z osobistym tokenem dostępu konta.',
...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.gitlab.status.tokenRejected': 'GitLab nie przyjął tego tokenu. Sprawdź, czy należy do tej instancji i ma dostęp do API.',
