...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.git.agentAuthority': '在代理 Shell 中应用身份',
  'settings.openchamber.git.agentAuthorityAria': '在代理 Shell 中应用身份',
  'settings.openchamber.git.agentAuthorityInfo': '代理自己运行的 Git 会得到仓库的身份而不是本机设置，并被要求使用 OpenChamber 工具而不是直接传输。使用系统 Git 的仓库保留本机设置。在下次 OpenCode 重启后生效，绝不影响你自己的终端。',
  ...
  'settings.sourceControl.agentAuthority.label': '在代理 Shell 中应用此仓库的身份',
  'settings.sourceControl.agentAuthority.info': '关闭后，代理在此运行的 Git 保留本机设置，Shell 中的直接传输也不会被拒绝。在下次 OpenCode 重启后生效。',
  'settings.sourceControl.agentAuthority.machineOff': '本机未在代理 Shell 中应用身份。请在设置 → Git 中开启。',
