...
export const settingsDict = {
  ...
  'settings.providers.page.ollamaCloud.help': '请从 ollama.com 浏览器开发者工具的请求标头中复制完整的 Cookie 标头，然后粘贴到此处。仅存储和发送会话 Cookie：wos-session=...（旧账户可能使用 __Secure-session=...）。标头中的其他 Cookie 不会被转发。这不是本地 Ollama API 密钥或端点。OpenChamber 绝不会扫描浏览器 Cookie 存储。',
