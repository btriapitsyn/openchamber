...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.providers.freeinference.description': '连接您的 FreeInference API 密钥以发现并使用可用模型。',
  'settings.providers.freeinference.attribution': '由 Harvard SEAS 的 Harvard MadSys 课题组提供。',
  'settings.providers.freeinference.apiKeyLabel': 'FreeInference API 密钥',
  'settings.providers.freeinference.apiKeyPlaceholder': '输入您的 FreeInference API 密钥',
  'settings.providers.freeinference.connect': '连接 FreeInference',
  'settings.providers.freeinference.connecting': '连接中...',
  'settings.providers.freeinference.syncModels': '刷新模型',
  'settings.providers.freeinference.syncing': '刷新中...',
  'settings.providers.freeinference.modelsRefreshed': 'FreeInference 模型已刷新（{count} 个可用）',
  'settings.providers.freeinference.refreshFailed': '刷新 FreeInference 模型失败',
  'settings.providers.freeinference.infoHint': '模型会针对您经过身份验证的密钥从 FreeInference API 动态获取。',
