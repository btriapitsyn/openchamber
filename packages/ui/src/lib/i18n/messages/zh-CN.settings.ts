...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.tools.field.serverBrowser': '服务器浏览器',
  'settings.openchamber.tools.field.serverBrowserAria': '启用服务器浏览器',
  'settings.openchamber.tools.field.serverBrowserInfo': '在此服务器上运行 Chrome 浏览器，让智能体在没有任何已连接窗口可以响应时也能浏览页面，并让你从任何设备查看和操作相同的页面。默认关闭，立即生效；关闭时会停止 Chrome 并关闭其会话与查看者。',
  'settings.openchamber.tools.browserDebugPort.label': '浏览器 CDP 端口',
  'settings.openchamber.tools.browserDebugPort.info': '选择用于本地 MCP 连接的端口。保存的设置将在下次启动 Chrome 时生效，当前标签页会保持打开。',
  'settings.openchamber.tools.browserDebugPort.automatic': '自动',
  'settings.openchamber.tools.browserDebugPort.fixed': '固定端口',
  'settings.openchamber.tools.browserDebugPort.input': '固定 CDP 端口',
  'settings.openchamber.tools.browserDebugPort.invalid': '请输入 1 到 65535 之间的整数。',
  'settings.openchamber.tools.browserDebugPort.save': '保存端口',
  'settings.openchamber.tools.browserDebugPort.configuredAutomatic': '已配置的端口：自动',
  'settings.openchamber.tools.browserDebugPort.configuredFixed': '已配置的端口：{port}',
  'settings.openchamber.tools.browserDebugPort.loading': '正在检查浏览器状态…',
  'settings.openchamber.tools.browserDebugPort.unavailable': '无法获取浏览器状态。',
  'settings.openchamber.tools.browserDebugPort.stopped': 'Chrome 未运行。',
  'settings.openchamber.tools.browserDebugPort.active': '使用中的端口：{port}',
  'settings.openchamber.tools.browserDebugPort.pending': '保存的端口将在下次启动 Chrome 时生效。',
  'settings.openchamber.tools.browserDebugPort.refresh': '刷新状态',
  'settings.openchamber.tools.browserDebugPort.copy': '复制浏览器 URL',
  'settings.openchamber.tools.browserDebugPort.copied': '已复制浏览器 URL',
  'settings.openchamber.tools.browserDebugPort.copyFailed': '无法复制浏览器 URL。',
  'settings.openchamber.tools.browserDebugPort.connectionInfo': '此环回地址属于服务器所在的计算机。请在该计算机上使用 --browserUrl 运行 MCP，或使用自行设置的 SSH 隧道。直接 MCP 连接不使用"接管控制权"。',
