...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.visual.field.activityColorCoding': '工具与活动颜色标识',
  'settings.openchamber.visual.field.activityColorCodingAria': '为工具与活动行使用颜色标识',
  'settings.openchamber.visual.field.activityColorCodingHint': '为每种工具和活动行分配主题强调色——文件编辑、Shell 命令、搜索、思考等。关闭后使用单一中性色调。',
