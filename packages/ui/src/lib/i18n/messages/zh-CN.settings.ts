...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.notifications.page.sounds.title': '通知声音',
  'settings.notifications.page.sounds.enableLabel': '为代理事件播放声音',
  'settings.notifications.page.sounds.enableAria': '为代理事件播放声音',
  'settings.notifications.page.sounds.hint': '为完成、错误和问题播放音频提示。使用上方的焦点和事件设置。',
  'settings.notifications.page.sounds.volumeLabel': '音量',
  'settings.notifications.page.sounds.previewAction': '预览声音',
  'settings.notifications.page.sounds.previewAria': '预览通知声音',
