...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.voice.page.field.funasrProtocol': "FunASR 协议",
  'settings.voice.page.field.funasrProtocolHint': "选择与运行中的服务端一致的协议：Python 需要 is_end 完成确认；C++ 使用双遍或离线响应。此设置不会更改服务端。",
  'settings.voice.page.protocol.python': "Python（完成确认）",
  'settings.voice.page.protocol.cpp2pass': "C++ 双遍",
  'settings.voice.page.protocol.cppOffline': "C++ 离线",
