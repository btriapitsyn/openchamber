...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.gitIdentities.editor.auth.token': '令牌',
  'settings.gitIdentities.editor.auth.anonymous': '匿名',
  'settings.gitIdentities.editor.auth.ssh': 'SSH',
  'settings.gitIdentities.editor.auth.oauthHint': '使用账户的 OAuth 登录进行 push 和 pull。',
  ...
  'settings.gitIdentities.page.signatureOnly': '仅签名，来自旧版本',
  ...
  'settings.page.integrations.description': '连接 GitHub、GitLab 和 Linear，让 OpenChamber 可以处理你的 issue、拉取请求和合并请求。',
} as const;
