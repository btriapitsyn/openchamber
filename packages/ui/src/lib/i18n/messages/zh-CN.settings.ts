...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.gitIdentities.editor.field.account': '源代码管理账户',
  'settings.gitIdentities.editor.field.accountNone': '不使用账户',
  'settings.gitIdentities.editor.auth.label': '认证方式',
  'settings.gitIdentities.editor.auth.account': '账户',
  'settings.gitIdentities.editor.auth.ssh': 'SSH',
  'settings.gitIdentities.editor.auth.system': '系统',
  'settings.gitIdentities.editor.auth.anonymous': '匿名',
  'settings.gitIdentities.editor.auth.accountHint': '使用已连接账户自身的凭据进行 push 和 pull。',
  'settings.gitIdentities.editor.auth.systemHint': '使用已连接主机上已有的 Git 凭据。OpenChamber 无法验证它们属于哪个账户。',
  'settings.gitIdentities.editor.auth.anonymousHint': '无凭据的公开 HTTPS — 只读。',
  ...
  'settings.openchamber.git.agentAuthority': '在代理终端中响应 Git',
  'settings.openchamber.git.agentAuthorityAria': '在代理终端中响应 Git',
  'settings.openchamber.git.agentAuthorityInfo': '对于在此配置的仓库，OpenChamber 会把绑定的账户提供给代理自己运行的 Git，并要求它使用 OpenChamber 工具而不是直接传输。使用系统 Git 的仓库和未配置传输的仓库仍使用本机自己的设置。下次重启 OpenCode 后生效，且从不影响你自己的终端。',
  ...
  'settings.sourceControl.agentAuthority.title': '代理终端',
  'settings.sourceControl.agentAuthority.label': '在此仓库中响应 Git',
  'settings.sourceControl.agentAuthority.info': '关闭后，代理在此运行的 Git 会使用本机自己的设置而不是绑定的账户，终端中的直接传输也不会被拒绝。下次重启 OpenCode 后生效。',
  'settings.sourceControl.agentAuthority.machineOff': '本机已在「设置 → Git」中关闭了在代理终端中响应 Git。',
