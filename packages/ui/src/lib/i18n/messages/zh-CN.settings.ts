...
export const settingsDict = {
  ...
  'settings.openchamber.tunnel.description': '通过快速链接或你自己的 Cloudflare 托管远程隧道配置安全远程访问。',
  ...
  'settings.openchamber.tunnel.note.managedRemoteRequiresDomain': '托管远程隧道需要你在 Cloudflare 账户中购买的域名。',
  'settings.openchamber.tunnel.note.managedLocalUsesConfig': '托管本地隧道使用本地 cloudflared 配置文件。',
  ...
  'settings.openchamber.tunnel.section.savedManagedRemoteTunnels': '已保存的托管远程隧道',
  ...
  'settings.openchamber.tunnel.field.managedRemoteTokenInfoAria': '托管远程隧道 token 信息',
  ...
  'settings.openchamber.tunnel.field.managedRemoteTunnelToConnect': '用于连接的托管远程隧道',
  ...
  'settings.openchamber.tunnel.actions.openManagedRemoteDocs': '查看托管远程隧道配置文档',
  'settings.openchamber.tunnel.actions.openManagedLocalDocs': '查看托管本地隧道配置文档',
  ...
  'settings.openchamber.tunnel.option.mode.quick.tooltip': '快速隧道仅尽力提供，不保证可用性。',
  'settings.openchamber.tunnel.option.mode.managedRemote.label': '托管远程',
  'settings.openchamber.tunnel.option.mode.managedRemote.tooltip': '托管远程使用你的 Cloudflare 账户与主机名提供长期访问。',
  'settings.openchamber.tunnel.option.mode.managedLocal.label': '托管本地',
  'settings.openchamber.tunnel.option.mode.managedLocal.tooltip': '托管本地使用本地 cloudflared 配置文件。',
  'settings.openchamber.tunnel.warning.quickModeReliability': '如需更可靠的长期访问，请切换到托管远程或托管本地隧道模式。',
  'settings.openchamber.tunnel.warning.replacesActiveTunnel': '启动该隧道会替换当前活动隧道，并吊销现有连接链接与远程会话。',
  'settings.openchamber.tunnel.badge.quick': '快捷',
  ...
  'settings.openchamber.tunnel.empty.noManagedRemoteTunnels': '尚未保存任何托管远程隧道。',
  ...
  'settings.openchamber.tunnel.toast.saveTokenFailed': '保存托管远程隧道 token 失败',
  'settings.openchamber.tunnel.toast.selectOrAddManagedRemoteFirst': '请先选择或添加一个托管远程隧道',
  'settings.openchamber.tunnel.toast.managedRemoteTokenRequiredBeforeStarting': '启动前必须提供托管远程隧道 token',
  'settings.openchamber.tunnel.toast.addManagedRemoteTokenBeforeStarting': '请先添加托管远程隧道 token 再启动',
  ...
  'settings.openchamber.tunnel.toast.saveSelectedManagedRemoteFailed': '保存所选托管远程隧道失败',
  'settings.openchamber.tunnel.toast.tunnelNameRequired': '隧道名称为必填项',
  'settings.openchamber.tunnel.toast.managedRemoteHostnameRequired': '托管远程隧道主机名为必填项',
  'settings.openchamber.tunnel.toast.managedRemoteTokenRequired': '托管远程隧道 token 为必填项',
  'settings.openchamber.tunnel.toast.hostnameAlreadyExists': '该主机名已存在',
  'settings.openchamber.tunnel.toast.managedRemoteSaved': '托管远程隧道已保存',
  'settings.openchamber.tunnel.toast.managedRemoteRemoved': '托管远程隧道已移除',
  ...
  'settings.remoteInstances.direct.headers.description': '桌面端 API 请求的可选 HTTP 头。Authorization 保留用于连接令牌。',
  ...
  'settings.openchamber.visual.section.followUpBehavior': '后续行为',
  'settings.openchamber.visual.section.followUpBehaviorAria': '后续行为',
  'settings.openchamber.visual.field.followUpBehaviorAria': '后续行为：{option}',
